...
_BSS	ENDS
CONST	SEGMENT
$SG166612 DB	'CCAMClient::validate', 00H
	ORG $+3
$SG166613 DB	'.\CAMClient.cpp', 00H
$SG166615 DB	'CCAMClient::validate', 00H
	ORG $+3
$SG166616 DB	'.\CAMClient.cpp', 00H
$SG166618 DB	'CCAMClient::validate', 00H
	ORG $+3
$SG166619 DB	'.\CAMClient.cpp', 00H
$SG166624 DB	'CCAMClient::validate', 00H
	ORG $+3
$SG166625 DB	'.\CAMClient.cpp', 00H
$SG166649 DB	'CCAMClient::newBinString', 00H
	ORG $+3
$SG166650 DB	'.\CAMClient.cpp', 00H
$SG166652 DB	'CCAMClient::newBinString', 00H
	ORG $+3
$SG166653 DB	'.\CAMClient.cpp', 00H
$SG166659 DB	'CCAMClient::delBinString', 00H
	ORG $+3
$SG166660 DB	'.\CAMClient.cpp', 00H
$SG166661 DB	'CCAMClient::delBinString', 00H
	ORG $+3
$SG166662 DB	'.\CAMClient.cpp', 00H
$SG166680 DB	'serialize flat allocation', 00H
	ORG $+2
$SG166720 DB	'%d.%d.%d.%d', 00H
$SG166775 DB	'read bfr', 00H
	ORG $+3
$SG166793 DB	'rb', 00H
	ORG $+1
$SG166840 DB	'pp != 0', 00H
$SG166841 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
...
; 122  : 		zFree(*dest_cert_ascii_bfr);
	...
	push	OFFSET FLAT:$SG166612
	push	122					; 0000007aH
	push	OFFSET FLAT:$SG166613
...
; 124  : 	*dest_cert_ascii_bfr = (unsigned char *)zMalloc(ptr->cert_ascii.size);
	...
	push	OFFSET FLAT:$SG166615
	push	124					; 0000007cH
	push	OFFSET FLAT:$SG166616
...
; 128  : 		zFree(*dest_ca_msg_bfr);
	...
	push	OFFSET FLAT:$SG166618
	push	128					; 00000080H
	push	OFFSET FLAT:$SG166619
...
; 153  : 	encodedDataPtr = (BYTE *)zMalloc(encodedDataSize + 1);
	...
	push	OFFSET FLAT:$SG166624
	push	153					; 00000099H
	push	OFFSET FLAT:$SG166625
...
; 192  :   BinString *me = (BinString*)zMalloc(sizeof(BinString));
	...
	push	OFFSET FLAT:$SG166649
	push	192					; 000000c0H
	push	OFFSET FLAT:$SG166650
	push	8
	call	_myMalloc
	add	esp, 16					; 00000010H
...
; 196  :   me->data = (unsigned char*)zMalloc(size);
	...
	push	OFFSET FLAT:$SG166652
	push	196					; 000000c4H
	push	OFFSET FLAT:$SG166653
...
; 203  :   zFree(me->data);
	...
	push	OFFSET FLAT:$SG166659
	push	203					; 000000cbH
	push	OFFSET FLAT:$SG166660
	mov	eax, DWORD PTR _me$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	push	ecx
	call	_myFree
...
; 204  :   zFree(me);
	...
	push	OFFSET FLAT:$SG166661
	push	204					; 000000ccH
	push	OFFSET FLAT:$SG166662
...
; 286  : 		i= sscanf (hostname, "%d.%d.%d.%d", &temp[0], &temp[1], &temp[2], &temp[3]);
	...
	lea	edx, DWORD PTR _temp$166719[ebp+12]
	push	edx
	lea	eax, DWORD PTR _temp$166719[ebp+8]
	push	eax
	lea	ecx, DWORD PTR _temp$166719[ebp+4]
	push	ecx
	lea	edx, DWORD PTR _temp$166719[ebp]
	push	edx
	push	OFFSET FLAT:$SG166720
	mov	eax, DWORD PTR _hostname$[ebp]
	push	eax
	call	_sscanf
	add	esp, 24					; 00000018H
...
$L166722:
	...
	mov	eax, DWORD PTR _i$[ebp]
	mov	cl, BYTE PTR _temp$166719[ebp+eax*4]
	mov	BYTE PTR [edx], cl
	jmp	SHORT $L166723
$L166724:
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlbase.h
xdata$x	SEGMENT
$T167166 DD	0ffffffffH
	DD	FLAT:$L167159
$T167163 DD	019930520H
	DD	01H
	DD	FLAT:$T167166
	DD	2 DUP(00H)
	DD	2 DUP(00H)
