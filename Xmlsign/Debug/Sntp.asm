...
_DATA	ENDS
CONST	SEGMENT
$SG161852 DB	'JD >= 0', 00H
$SG161853 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG161951 DB	'wMilliSeconds < 1000', 00H
	ORG $+3
$SG161952 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG161986 DB	'm_hSocket != (SOCKET)(~0)', 00H
	ORG $+2
$SG161987 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162011 DB	'm_hSocket != (SOCKET)(~0)', 00H
	ORG $+2
$SG162012 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162020 DB	'm_hSocket != (SOCKET)(~0)', 00H
	ORG $+2
$SG162021 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162028 DB	'(-1) != closesocket(m_hSocket)', 00H
	ORG $+1
$SG162029 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162072 DB	'pszHostName', 00H
$SG162073 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162082 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162083 DB	'Failed to create client socket, GetLastError returns: %d'
	DB	0aH, 00H
	ORG $+2
$SG162086 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162087 DB	'Could not connect to the SNTP server %s on port %d, GetL'
	DB	'astError returns: %d', 0aH, 00H
	ORG $+2
$SG162101 DB	'.\Sntp.cpp', 00H
	ORG $+5
$SG162102 DB	'Failed in call to send NTP request to the SNTP server, G'
	DB	'etLastError returns %d', 0aH, 00H
$SG162110 DB	'.\Sntp.cpp', 00H
	ORG $+5
$SG162111 DB	'Unable to wait for NTP reply from the SNTP server, GetLa'
	DB	'stError returns %d', 0aH, 00H
$SG162121 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162122 DB	'Unable to read reply from the SNTP server, GetLastError '
	DB	'returns %d', 0aH, 00H
$SG162142 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162143 DB	'Failed to get Adjust priviledge token', 0aH, 00H
	ORG $+1
$SG162146 DB	'SeSystemtimePrivilege', 00H
	ORG $+2
$SG162148 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162149 DB	'Failed in callup to lookup priviledge', 0aH, 00H
	ORG $+1
$SG162153 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162154 DB	'Failed to adjust SetTime priviledge', 0aH, 00H
	ORG $+3
$SG162161 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162162 DB	'Failed to reset SetTime priviledge', 0aH, 00H
$SG162174 DB	'.\Sntp.cpp', 00H
	ORG $+1
$SG162175 DB	'Failed in call to set the system time', 0aH, 00H
	ORG $+1
$SG162198 DB	'pp != 0', 00H
	ORG $+4
$SG162199 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
...
; 287  :   ATLASSERT(JD >= 0);//NTP only supports dates greater than 1900
	...
	jns	SHORT $L162575
	push	OFFSET FLAT:$SG161852
	push	0
	push	287					; 0000011fH
	push	OFFSET FLAT:$SG161853
	push	2
	call	__CrtDbgReport
...
tv90 = -44						; size = 4
tv89 = -40						; size = 4
_diff$161898 = -32					; size = 8
_diff$161896 = -16					; size = 8
_this$ = -4						; size = 4
_time$ = 8						; size = 4
...
; 352  :     CNtpTime diff;
	...
	lea	ecx, DWORD PTR _diff$161896[ebp]
...
; 353  : 		diff.m_Time = m_Time - time.m_Time;
	...
	mov	DWORD PTR _diff$161896[ebp], ecx
	mov	DWORD PTR _diff$161896[ebp+4], edx
...
; 358  : 	  CNtpTime diff;
	...
	lea	ecx, DWORD PTR _diff$161898[ebp]
	call	??0CNtpTime@@QAE@XZ			; CNtpTime::CNtpTime
...
; 359  : 		diff.m_Time = time.m_Time - m_Time;
	...
	mov	DWORD PTR _diff$161898[ebp], edx
	mov	DWORD PTR _diff$161898[ebp+4], eax
...
CONST	ENDS
_TEXT	SEGMENT
_frac$161916 = -92					; size = 8
_intpart$161915 = -80					; size = 8
_diff$161913 = -68					; size = 8
_d$161912 = -60						; size = 8
_frac$161909 = -52					; size = 8
_intpart$161908 = -40					; size = 8
_diff$161906 = -28					; size = 8
_rVal$ = -16						; size = 8
_this$ = -4						; size = 4
...
; 371  : 	  unsigned __int64 diff = ((unsigned __int64) timespan) << 32;
	...
	mov	cl, 32					; 00000020H
	call	__allshl
	mov	DWORD PTR _diff$161906[ebp], eax
	mov	DWORD PTR _diff$161906[ebp+4], edx

; 372  :     double intpart;
; 373  : 	  double frac = modf(timespan, &intpart);

	lea	edx, DWORD PTR _intpart$161908[ebp]
	push	edx
	mov	eax, DWORD PTR _timespan$[ebp]
	fld	QWORD PTR [eax]
	sub	esp, 8
	...
	call	_modf
	add	esp, 12					; 0000000cH
	fst	QWORD PTR _frac$161909[ebp]

; 374  : 	  diff += (unsigned __int64) (frac * 0xFFFFFFFF);

	fmul	QWORD PTR __real@41efffffffe00000
	call	__ftol2
	add	eax, DWORD PTR _diff$161906[ebp]
	mov	ecx, DWORD PTR _diff$161906[ebp+4]
	adc	ecx, edx
	mov	DWORD PTR _diff$161906[ebp], eax
	mov	DWORD PTR _diff$161906[ebp+4], ecx

; 375  : 
; 376  : 		rVal.m_Time += diff;

	mov	edx, DWORD PTR _rVal$[ebp]
	add	edx, DWORD PTR _diff$161906[ebp]
	mov	eax, DWORD PTR _rVal$[ebp+4]
	adc	eax, DWORD PTR _diff$161906[ebp+4]
...
; 381  : 	  unsigned __int64 diff = ((unsigned __int64) d) << 32;
	...
	mov	cl, 32					; 00000020H
	call	__allshl
	mov	DWORD PTR _diff$161913[ebp], eax
	mov	DWORD PTR _diff$161913[ebp+4], edx

; 382  :     double intpart;
; 383  : 	  double frac = modf(d, &intpart);

	lea	edx, DWORD PTR _intpart$161915[ebp]
	push	edx
	fld	QWORD PTR _d$161912[ebp]
	sub	esp, 8
	fstp	QWORD PTR [esp]
	call	_modf
	add	esp, 12					; 0000000cH
	fst	QWORD PTR _frac$161916[ebp]

; 384  : 		diff += (unsigned __int64) (frac * 0xFFFFFFFF);

	fmul	QWORD PTR __real@41efffffffe00000
	call	__ftol2
	add	eax, DWORD PTR _diff$161913[ebp]
	mov	ecx, DWORD PTR _diff$161913[ebp+4]
	adc	ecx, edx
	mov	DWORD PTR _diff$161913[ebp], eax
	mov	DWORD PTR _diff$161913[ebp+4], ecx

; 385  : 
; 386  : 		rVal.m_Time -= diff;

	mov	edx, DWORD PTR _rVal$[ebp]
	sub	edx, DWORD PTR _diff$161913[ebp]
	mov	eax, DWORD PTR _rVal$[ebp+4]
	sbb	eax, DWORD PTR _diff$161913[ebp+4]
	mov	DWORD PTR _rVal$[ebp], edx
	mov	DWORD PTR _rVal$[ebp+4], eax
$L161911:
...
; 441  :   ATLASSERT(wMilliSeconds < 1000);
	...
	jl	SHORT $L162637
	push	OFFSET FLAT:$SG161951
	push	0
	push	441					; 000001b9H
	push	OFFSET FLAT:$SG161952
	push	2
	call	__CrtDbgReport
	add	esp, 20					; 00000014H
	cmp	eax, 1
...
; 484  : 	ATLASSERT(m_hSocket != INVALID_SOCKET);
	...
	cmp	DWORD PTR [eax], -1
	jne	SHORT $L162647
	push	OFFSET FLAT:$SG161986
	push	0
	push	484					; 000001e4H
	push	OFFSET FLAT:$SG161987
	push	2
	call	__CrtDbgReport
	add	esp, 20					; 00000014H
	cmp	eax, 1
...
; 499  : 		lphost = gethostbyname(lpszAscii);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _lphost$161993[ebp], eax

; 500  : 		if (lphost != NULL)

	cmp	DWORD PTR _lphost$161993[ebp], 0
	je	SHORT $L161994

; 501  : 			sockAddr.sin_addr.s_addr = ((LPIN_ADDR)lphost->h_addr)->s_addr;

	mov	ecx, DWORD PTR _lphost$161993[ebp]
...
; 520  :   ATLASSERT(m_hSocket != INVALID_SOCKET);
	...
	cmp	DWORD PTR [eax], -1
	jne	SHORT $L162658
	push	OFFSET FLAT:$SG162011
	push	0
	push	520					; 00000208H
	push	OFFSET FLAT:$SG162012
	push	2
	call	__CrtDbgReport
	add	esp, 20					; 00000014H
	cmp	eax, 1
...
; 527  :   ATLASSERT(m_hSocket != INVALID_SOCKET);
	...
	cmp	DWORD PTR [eax], -1
	jne	SHORT $L162660
	push	OFFSET FLAT:$SG162020
	push	0
	push	527					; 0000020fH
	push	OFFSET FLAT:$SG162021
	push	2
	call	__CrtDbgReport
	add	esp, 20					; 00000014H
	cmp	eax, 1
...
; 535  : 		ATLASSERT (SOCKET_ERROR != closesocket(m_hSocket));
	...
	cmp	eax, -1
	jne	SHORT $L162662
	push	OFFSET FLAT:$SG162028
	push	0
	push	535					; 00000217H
	push	OFFSET FLAT:$SG162029
	push	2
	call	__CrtDbgReport
	add	esp, 20					; 00000014H
	cmp	eax, 1
...
; 547  :   FD_SET(m_hSocket, &fds);
	...
	mov	DWORD PTR ___i$162042[ebp], 0
	jmp	SHORT $L162044
$L162045:
	mov	edx, DWORD PTR ___i$162042[ebp]
	add	edx, 1
	mov	DWORD PTR ___i$162042[ebp], edx
$L162044:
	mov	eax, DWORD PTR ___i$162042[ebp]
	cmp	eax, DWORD PTR _fds$[ebp]
	jae	SHORT $L162046
	mov	ecx, DWORD PTR ___i$162042[ebp]
	mov	edx, DWORD PTR _this$[ebp]
...
xdata$x	SEGMENT
$T162722 DD	0ffffffffH
	DD	FLAT:$L162707
$T162711 DD	019930520H
	DD	01H
	DD	FLAT:$T162722
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
$T162673 = -212						; size = 4
$T162672 = -208						; size = 4
_dwError$162123 = -204					; size = 4
_nReceiveSize$162116 = -200				; size = 4
_nfp$162115 = -192					; size = 68
_bReadable$162106 = -116				; size = 4
_dwError$162103 = -108					; size = 4
_nSendSize$162093 = -104				; size = 4
_nbi$162092 = -96					; size = 48
_dwError$162088 = -44					; size = 4
_pSocket$ = -40						; size = 4
__lpa$ = -36						; size = 4
__lpw$ = -32						; size = 4
__acp$ = -28						; size = 4
...
; 573  :   ATLASSERT(pszHostName);
	...
	jne	SHORT $L162671
	push	OFFSET FLAT:$SG162072
	push	0
	push	573					; 0000023dH
	push	OFFSET FLAT:$SG162073
	push	2
	call	__CrtDbgReport
	add	esp, 20					; 00000014H
	cmp	eax, 1
...
; 577  : 	CNtpSocket* pSocket = new CNtpSocket();
	...
	add	esp, 4
	mov	DWORD PTR $T162673[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T162673[ebp], 0
	je	SHORT $L162674
	mov	ecx, DWORD PTR $T162673[ebp]
...
$L162675:
	...
	mov	DWORD PTR $T162672[ebp], ecx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	edx, DWORD PTR $T162672[ebp]
...
; 580  : 		ATLTRACE(_T("Failed to create client socket, GetLastError returns: %d\n"), GetLastError());
	...
	call	__RTC_CheckEsp
	push	eax
	push	OFFSET FLAT:$SG162083
	push	580					; 00000244H
	push	OFFSET FLAT:$SG162082
	lea	ecx, DWORD PTR $T162676[ebp]
...
; 587  : 		ATLTRACE(_T("Could not connect to the SNTP server %s on port %d, GetLastError returns: %d\n"), pszHostName, nPort, GetLastError());
	...
	push	eax
	push	OFFSET FLAT:$SG162087
	push	587					; 0000024bH
	push	OFFSET FLAT:$SG162086
	lea	ecx, DWORD PTR $T162677[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 20					; 00000014H
...
; 590  : 		DWORD dwError = GetLastError();
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _dwError$162088[ebp], eax

; 591  : 		delete pSocket;

	mov	ecx, DWORD PTR _pSocket$[ebp]
	mov	DWORD PTR $T162679[ebp], ecx
	mov	edx, DWORD PTR $T162679[ebp]
	mov	DWORD PTR $T162678[ebp], edx
	cmp	DWORD PTR $T162678[ebp], 0
	je	SHORT $L162680
	push	1
	mov	ecx, DWORD PTR $T162678[ebp]
...
; 592  : 		SetLastError(dwError);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _dwError$162088[ebp]
	push	eax
...
; 600  : 		int nSendSize = sizeof(NtpBasicInfo);
	...
	mov	DWORD PTR _nSendSize$162093[ebp], 48	; 00000030H

; 601  : 		ZeroMemory(&nbi, nSendSize);

	mov	ecx, DWORD PTR _nSendSize$162093[ebp]
	push	ecx
	push	0
	lea	edx, DWORD PTR _nbi$162092[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 602  : 			nbi.m_LiVnMode = 27; //Encoded representation which represents NTP Client Request & NTP version 3.0
	...
	mov	BYTE PTR _nbi$162092[ebp], 27		; 0000001bH

; 603  : 		nbi.m_TransmitTimestamp = CNtpTime::GetCurrentTime();

	lea	eax, DWORD PTR $T162683[ebp]
	push	eax
	lea	ecx, DWORD PTR $T162682[ebp]
	push	ecx
	...
	mov	edx, DWORD PTR $T162683[ebp]
	mov	DWORD PTR _nbi$162092[ebp+40], edx
	mov	eax, DWORD PTR $T162683[ebp+4]
	mov	DWORD PTR _nbi$162092[ebp+44], eax
...
; 608  : 		ATLTRACE(_T("Failed in call to send NTP request to the SNTP server, GetLastError returns %d\n"), GetLastError());
	...
	call	__RTC_CheckEsp
	push	eax
	push	OFFSET FLAT:$SG162102
	push	608					; 00000260H
	push	OFFSET FLAT:$SG162101
	lea	ecx, DWORD PTR $T162684[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 12					; 0000000cH
...
; 611  : 		DWORD dwError = GetLastError();
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _dwError$162103[ebp], eax

; 612  : 		delete pSocket;

	mov	eax, DWORD PTR _pSocket$[ebp]
	mov	DWORD PTR $T162686[ebp], eax
	mov	ecx, DWORD PTR $T162686[ebp]
	mov	DWORD PTR $T162685[ebp], ecx
	cmp	DWORD PTR $T162685[ebp], 0
	je	SHORT $L162687
	push	1
	mov	ecx, DWORD PTR $T162685[ebp]
	call	??_GCNtpSocket@@QAEPAXI@Z
...
; 613  : 		SetLastError(dwError);
	...
	mov	esi, esp
	mov	edx, DWORD PTR _dwError$162103[ebp]
	push	edx
	call	DWORD PTR __imp__SetLastError@4
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 620  : 		if (!pSocket->IsReadible(bReadable, m_dwTimeout) || !bReadable)
	...
	mov	ecx, DWORD PTR [eax]
	push	ecx
	lea	edx, DWORD PTR _bReadable$162106[ebp]
	push	edx
	mov	ecx, DWORD PTR _pSocket$[ebp]
	call	?IsReadible@CNtpSocket@@QAEHAAHK@Z	; CNtpSocket::IsReadible
	test	eax, eax
	je	SHORT $L162108
	cmp	DWORD PTR _bReadable$162106[ebp], 0
	jne	$L162107
$L162108:
...
; 622  : 		ATLTRACE(_T("Unable to wait for NTP reply from the SNTP server, GetLastError returns %d\n"), WSAETIMEDOUT);
	...
	push	OFFSET FLAT:$SG162111
	push	622					; 0000026eH
	push	OFFSET FLAT:$SG162110
	lea	ecx, DWORD PTR $T162689[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 12					; 0000000cH
...
; 625  : 		delete pSocket;
	...
	mov	eax, DWORD PTR _pSocket$[ebp]
	mov	DWORD PTR $T162691[ebp], eax
	mov	ecx, DWORD PTR $T162691[ebp]
	mov	DWORD PTR $T162690[ebp], ecx
	cmp	DWORD PTR $T162690[ebp], 0
	je	SHORT $L162692
	push	1
	mov	ecx, DWORD PTR $T162690[ebp]
	call	??_GCNtpSocket@@QAEPAXI@Z
...
; 634  : 		int nReceiveSize = sizeof(NtpFullPacket);
	...
	mov	DWORD PTR _nReceiveSize$162116[ebp], 68	; 00000044H

; 635  : 		ZeroMemory(&nfp, nReceiveSize);

	mov	eax, DWORD PTR _nReceiveSize$162116[ebp]
	push	eax
	push	0
	lea	ecx, DWORD PTR _nfp$162115[ebp]
	push	ecx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 636  : 		if (!pSocket->Receive((LPSTR) &nfp, nReceiveSize))
	...
	mov	edx, DWORD PTR _nReceiveSize$162116[ebp]
	push	edx
	lea	eax, DWORD PTR _nfp$162115[ebp]
	push	eax
	mov	ecx, DWORD PTR _pSocket$[ebp]
...
; 638  : 		ATLTRACE(_T("Unable to read reply from the SNTP server, GetLastError returns %d\n"), GetLastError());
	...
	call	__RTC_CheckEsp
	push	eax
	push	OFFSET FLAT:$SG162122
	push	638					; 0000027eH
	push	OFFSET FLAT:$SG162121
	lea	ecx, DWORD PTR $T162695[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 12					; 0000000cH
...
; 641  : 		DWORD dwError = GetLastError();
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _dwError$162123[ebp], eax

; 642  : 		delete pSocket;

	mov	ecx, DWORD PTR _pSocket$[ebp]
	mov	DWORD PTR $T162697[ebp], ecx
	mov	edx, DWORD PTR $T162697[ebp]
	mov	DWORD PTR $T162696[ebp], edx
	cmp	DWORD PTR $T162696[ebp], 0
	je	SHORT $L162698
	push	1
	mov	ecx, DWORD PTR $T162696[ebp]
	call	??_GCNtpSocket@@QAEPAXI@Z
...
; 643  : 		SetLastError(dwError);
	...
	mov	esi, esp
	mov	eax, DWORD PTR _dwError$162123[ebp]
	push	eax
	call	DWORD PTR __imp__SetLastError@4
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 651  : 			response.m_OriginateTime = nfp.m_Basic.m_OriginateTimestamp;
	...
	lea	edx, DWORD PTR _nfp$162115[ebp+24]
	push	edx
	lea	ecx, DWORD PTR $T162700[ebp]
	call	??0CNtpTime@@QAE@AAUCNtpTimePacket@@@Z	; CNtpTime::CNtpTime
	lea	eax, DWORD PTR $T162700[ebp]
	push	eax
	mov	ecx, DWORD PTR _response$[ebp]
	add	ecx, 8
	call	??4CNtpTime@@QAEAAV0@ABV0@@Z		; CNtpTime::operator=
...
; 652  : 		response.m_ReceiveTime = nfp.m_Basic.m_ReceiveTimestamp;
	...
	lea	ecx, DWORD PTR _nfp$162115[ebp+32]
	push	ecx
	lea	ecx, DWORD PTR $T162701[ebp]
	call	??0CNtpTime@@QAE@AAUCNtpTimePacket@@@Z	; CNtpTime::CNtpTime
	lea	edx, DWORD PTR $T162701[ebp]
	push	edx
	mov	ecx, DWORD PTR _response$[ebp]
...
; 653  : 		response.m_TransmitTime = nfp.m_Basic.m_TransmitTimestamp;
	...
	lea	eax, DWORD PTR _nfp$162115[ebp+40]
	push	eax
	lea	ecx, DWORD PTR $T162702[ebp]
	call	??0CNtpTime@@QAE@AAUCNtpTimePacket@@@Z	; CNtpTime::CNtpTime
	lea	ecx, DWORD PTR $T162702[ebp]
	push	ecx
	mov	ecx, DWORD PTR _response$[ebp]
...
; 658  : 		delete pSocket;
	...
	mov	DWORD PTR $T162704[ebp], edx
	mov	eax, DWORD PTR $T162704[ebp]
	mov	DWORD PTR $T162703[ebp], eax
	cmp	DWORD PTR $T162703[ebp], 0
	je	SHORT $L162705
	push	1
	mov	ecx, DWORD PTR $T162703[ebp]
	call	??_GCNtpSocket@@QAEPAXI@Z
...
; 678  :     ATLTRACE(_T("Failed to get Adjust priviledge token\n"));
	...
	push	OFFSET FLAT:$SG162143
	push	678					; 000002a6H
	push	OFFSET FLAT:$SG162142
	lea	ecx, DWORD PTR $T162727[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 8
...
; 684  :     ATLTRACE(_T("Failed in callup to lookup priviledge\n"));
	...
	push	OFFSET FLAT:$SG162149
	push	684					; 000002acH
	push	OFFSET FLAT:$SG162148
	lea	ecx, DWORD PTR $T162728[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 8
...
; 693  : 	  ATLTRACE(_T("Failed to adjust SetTime priviledge\n"));
	...
	push	OFFSET FLAT:$SG162154
	push	693					; 000002b5H
	push	OFFSET FLAT:$SG162153
	lea	ecx, DWORD PTR $T162729[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 8
...
; 704  : 		  ATLTRACE(_T("Failed to reset SetTime priviledge\n"));
	...
	push	OFFSET FLAT:$SG162162
	push	704					; 000002c0H
	push	OFFSET FLAT:$SG162161
	lea	ecx, DWORD PTR $T162731[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 8
...
; 713  :     SYSTEMTIME st = NewTime;
	...
	lea	eax, DWORD PTR $T162733[ebp]
	push	eax
	mov	ecx, DWORD PTR _NewTime$[ebp]
	call	??BCNtpTime@@QBE?AU_SYSTEMTIME@@XZ	; CNtpTime::operator _SYSTEMTIME
	mov	ecx, DWORD PTR $T162733[ebp]
	mov	DWORD PTR _st$162169[ebp], ecx
	mov	edx, DWORD PTR $T162733[ebp+4]
	mov	DWORD PTR _st$162169[ebp+4], edx
	mov	eax, DWORD PTR $T162733[ebp+8]
	mov	DWORD PTR _st$162169[ebp+8], eax
	mov	ecx, DWORD PTR $T162733[ebp+12]
	mov	DWORD PTR _st$162169[ebp+12], ecx

; 714  :     bSuccess = SetSystemTime(&st);

	mov	esi, esp
	lea	edx, DWORD PTR _st$162169[ebp]
	push	edx
...
; 716  :       ATLTRACE(_T("Failed in call to set the system time\n"));
	...
	push	OFFSET FLAT:$SG162175
	push	716					; 000002ccH
	push	OFFSET FLAT:$SG162174
	lea	ecx, DWORD PTR $T162734[ebp]
	call	??0CTraceFileAndLineInfo@ATL@@QAE@PBDH@Z ; ATL::CTraceFileAndLineInfo::CTraceFileAndLineInfo
	push	eax
	call	??RCTraceFileAndLineInfo@ATL@@QBAXPBDZZ	; ATL::CTraceFileAndLineInfo::operator()
	add	esp, 8
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlbase.h
xdata$x	SEGMENT
$T162765 DD	0ffffffffH
	DD	FLAT:$L162761
$T162763 DD	019930520H
	DD	01H
	DD	FLAT:$T162765
	DD	2 DUP(00H)
	DD	2 DUP(00H)
