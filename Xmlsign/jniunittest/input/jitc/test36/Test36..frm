...
Private Sub Form_Load()
    Dim res, SecureXML, fSystem, fHandle
    Set SecureXML = CreateObject("XMLSign.Signature")
    Set fSystem = CreateObject("Scripting.FileSystemObject")
    Set fHandle = fSystem.CreateTextFile("C:\ActiveX\CPP\X509tests\test36\JITC-TestResults.txt", 1)
    ...
    expectedRes = 0
        ...
        ActiveCertPath = "C:\ActiveX\CPP\X509tests\test36\test36.p12"
        crlList3(0) = "C:\ActiveX\CPP\X509tests\test36\Trust Anchor CRL CP.01.01.crl"
        crlList3(1) = "C:\ActiveX\CPP\X509tests\test36\Intermediate CRL 1 PP.01.03.crl"
        crlList3(2) = "C:\ActiveX\CPP\X509tests\test36\Intermediate CRL 2 PP.01.03.crl"
