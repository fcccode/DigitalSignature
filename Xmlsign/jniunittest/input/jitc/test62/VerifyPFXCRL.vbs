...
expectedRes = 1
	...
	ActiveCertPath = "test62.p12"
	crlList5(0) = "Trust Anchor CRL CP.01.01.crl"
	crlList5(1) = "Intermediate CRL 1 PL.01.09.crl"
	crlList5(2) = "Intermediate CRL 2 PL.01.09.crl"
	crlList5(3) = "Intermediate CRL 3 PL.01.09.crl"
	crlList5(4) = "Intermediate CRL 4 PL.01.09.crl"
	...
	if res = expectedRes then
		...
		fHandle.writeline("Test 62 Failed. Certificate Validation Failed " & "Last Error: " & SecureXML.GetLastError)
	End if
