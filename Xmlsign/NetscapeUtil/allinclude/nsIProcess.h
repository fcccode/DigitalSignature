...
#define NS_IPROCESS_IID_STR "3ed86dbe-d084-11d4-ba7a-00c04fa0d26b"

#define NS_IPROCESS_IID \
  {0x3ed86dbe, 0xd084, 0x11d4, \
    { 0xba, 0x7a, 0x00, 0xc0, 0x4f, 0xa0, 0xd2, 0x6b }}
...
/** Executes the file this object was initialized with
  ...
  NS_IMETHOD GetEnvironment(const char *aName, char **_retval) = 0;
...
#define NS_DECL_NSIPROCESS \
  ...
  NS_IMETHOD GetEnvironment(const char *aName, char **_retval); 
...
#define NS_FORWARD_NSIPROCESS(_to) \
  ...
  NS_IMETHOD GetEnvironment(const char *aName, char **_retval) { return _to GetEnvironment(aName, _retval); } 
...
#define NS_FORWARD_SAFE_NSIPROCESS(_to) \
  ...
  NS_IMETHOD GetEnvironment(const char *aName, char **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetEnvironment(aName, _retval); } 
...
/* string getEnvironment (in string aName); */
NS_IMETHODIMP nsProcess::GetEnvironment(const char *aName, char **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
