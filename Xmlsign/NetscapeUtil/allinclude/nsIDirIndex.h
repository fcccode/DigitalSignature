...
class NS_NO_VTABLE nsIDirIndex : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetLastModified(PRInt64 *aLastModified) = 0;
  NS_IMETHOD SetLastModified(PRInt64 aLastModified) = 0;
...
#define NS_DECL_NSIDIRINDEX \
  ...
  NS_IMETHOD GetLastModified(PRInt64 *aLastModified); \
  NS_IMETHOD SetLastModified(PRInt64 aLastModified); 
...
#define NS_FORWARD_NSIDIRINDEX(_to) \
  ...
  NS_IMETHOD GetLastModified(PRInt64 *aLastModified) { return _to GetLastModified(aLastModified); } \
  NS_IMETHOD SetLastModified(PRInt64 aLastModified) { return _to SetLastModified(aLastModified); } 
...
#define NS_FORWARD_SAFE_NSIDIRINDEX(_to) \
  ...
  NS_IMETHOD GetLastModified(PRInt64 *aLastModified) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetLastModified(aLastModified); } \
  NS_IMETHOD SetLastModified(PRInt64 aLastModified) { return !_to ? NS_ERROR_NULL_POINTER : _to->SetLastModified(aLastModified); } 
...
/* attribute unsigned long size; */
NS_IMETHODIMP nsDirIndex::GetSize(PRUint32 *aSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDirIndex::SetSize(PRUint32 aSize)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}

/* attribute long long lastModified; */
NS_IMETHODIMP nsDirIndex::GetLastModified(PRInt64 *aLastModified)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
NS_IMETHODIMP nsDirIndex::SetLastModified(PRInt64 aLastModified)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
