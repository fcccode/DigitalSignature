...
class NS_NO_VTABLE nsIProgressEventSink : public nsISupports {
 public: 
  ...
  /**
     ...
     */
  /* void onProgress (in nsIRequest aRequest, in nsISupports aContext, in unsigned long aProgress, in unsigned long aProgressMax); */
  NS_IMETHOD OnProgress(nsIRequest *aRequest, nsISupports *aContext, PRUint32 aProgress, PRUint32 aProgressMax) = 0;
...
#define NS_DECL_NSIPROGRESSEVENTSINK \
  NS_IMETHOD OnProgress(nsIRequest *aRequest, nsISupports *aContext, PRUint32 aProgress, PRUint32 aProgressMax); \
...
#define NS_FORWARD_NSIPROGRESSEVENTSINK(_to) \
  NS_IMETHOD OnProgress(nsIRequest *aRequest, nsISupports *aContext, PRUint32 aProgress, PRUint32 aProgressMax) { return _to OnProgress(aRequest, aContext, aProgress, aProgressMax); } \
...
#define NS_FORWARD_SAFE_NSIPROGRESSEVENTSINK(_to) \
  NS_IMETHOD OnProgress(nsIRequest *aRequest, nsISupports *aContext, PRUint32 aProgress, PRUint32 aProgressMax) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnProgress(aRequest, aContext, aProgress, aProgressMax); } \
...
/* void onProgress (in nsIRequest aRequest, in nsISupports aContext, in unsigned long aProgress, in unsigned long aProgressMax); */
NS_IMETHODIMP nsProgressEventSink::OnProgress(nsIRequest *aRequest, nsISupports *aContext, PRUint32 aProgress, PRUint32 aProgressMax)
{
