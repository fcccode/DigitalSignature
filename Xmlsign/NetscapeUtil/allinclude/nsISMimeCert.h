/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/manoj/mozilla/security/manager/ssl/public/nsISMimeCert.idl
 */
...
class NS_NO_VTABLE nsISMimeCert : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISMIMECERT_IID)
