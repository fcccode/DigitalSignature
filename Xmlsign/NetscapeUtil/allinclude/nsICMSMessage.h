/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/manoj/mozilla/security/manager/ssl/public/nsICMSMessage.idl
 */
...
class NS_NO_VTABLE nsICMSMessage : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICMSMESSAGE_IID)
