/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/manoj/mozilla/security/manager/ssl/public/nsICMSEncoder.idl
 */
...
class NS_NO_VTABLE nsICMSEncoder : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICMSENCODER_IID)
