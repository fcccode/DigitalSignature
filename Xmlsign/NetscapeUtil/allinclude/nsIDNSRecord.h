...
class NS_NO_VTABLE nsIDNSRecord : public nsISupports {
 public: 
  ...
  NS_IMETHOD GetNextAddr(PRUint16 port, union PRNetAddr *_retval) = 0;
...
#define NS_DECL_NSIDNSRECORD \
  ...
  NS_IMETHOD GetNextAddr(PRUint16 port, union PRNetAddr *_retval); \
...
#define NS_FORWARD_NSIDNSRECORD(_to) \
  ...
  NS_IMETHOD GetNextAddr(PRUint16 port, union PRNetAddr *_retval) { return _to GetNextAddr(port, _retval); } \
...
#define NS_FORWARD_SAFE_NSIDNSRECORD(_to) \
  ...
  NS_IMETHOD GetNextAddr(PRUint16 port, union PRNetAddr *_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetNextAddr(port, _retval); } \
...
/* [noscript] PRNetAddr getNextAddr (in PRUint16 port); */
NS_IMETHODIMP nsDNSRecord::GetNextAddr(PRUint16 port, union PRNetAddr *_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
