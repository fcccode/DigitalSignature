/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/manoj/mozilla/security/manager/ssl/public/nsICMSDecoder.idl
 */
...
class NS_NO_VTABLE nsICMSDecoder : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ICMSDECODER_IID)
