/*
 * DO NOT EDIT.  THIS FILE IS GENERATED FROM /home/manoj/mozilla/security/manager/boot/public/nsISSLStatusProvider.idl
 */
...
class NS_NO_VTABLE nsISSLStatusProvider : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_ISSLSTATUSPROVIDER_IID)

  /* readonly attribute nsISupports SSLStatus; */
  NS_IMETHOD GetSSLStatus(nsISupports * *aSSLStatus) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSISSLSTATUSPROVIDER \
  NS_IMETHOD GetSSLStatus(nsISupports * *aSSLStatus); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSISSLSTATUSPROVIDER(_to) \
  NS_IMETHOD GetSSLStatus(nsISupports * *aSSLStatus) { return _to GetSSLStatus(aSSLStatus); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSISSLSTATUSPROVIDER(_to) \
  NS_IMETHOD GetSSLStatus(nsISupports * *aSSLStatus) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetSSLStatus(aSSLStatus); } 
