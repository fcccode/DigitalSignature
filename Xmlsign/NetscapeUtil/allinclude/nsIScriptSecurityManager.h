...
class NS_NO_VTABLE nsIScriptSecurityManager : public nsIXPCSecurityManager {
 public: 
  ...
  NS_IMETHOD GetCertificatePrincipal(const char *CertID, nsIURI *aURI, nsIPrincipal **_retval) = 0;
...
#define NS_DECL_NSISCRIPTSECURITYMANAGER \
  ...
  NS_IMETHOD GetCertificatePrincipal(const char *CertID, nsIURI *aURI, nsIPrincipal **_retval); \
...
#define NS_FORWARD_NSISCRIPTSECURITYMANAGER(_to) \
  ...
  NS_IMETHOD GetCertificatePrincipal(const char *CertID, nsIURI *aURI, nsIPrincipal **_retval) { return _to GetCertificatePrincipal(CertID, aURI, _retval); } \
...
#define NS_FORWARD_SAFE_NSISCRIPTSECURITYMANAGER(_to) \
  ...
  NS_IMETHOD GetCertificatePrincipal(const char *CertID, nsIURI *aURI, nsIPrincipal **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetCertificatePrincipal(CertID, aURI, _retval); } \
...
/* [noscript] nsIPrincipal getCertificatePrincipal (in string CertID, in nsIURI aURI); */
NS_IMETHODIMP nsScriptSecurityManager::GetCertificatePrincipal(const char *CertID, nsIURI *aURI, nsIPrincipal **_retval)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
