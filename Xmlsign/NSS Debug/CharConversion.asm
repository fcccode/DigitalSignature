...
$SG181045 DB	'%d :', 00H
	ORG $+3
$SG181047 DB	'%s', 0aH, 00H
$SG181270 DB	0aH, '%10p ', 00H
	ORG $+1
$SG181274 DB	'%3x', 00H
$SG181278 DB	'   ', 00H
$SG181279 DB	' ', 00H
...
$SG181286 DB	'%c', 00H
	ORG $+1
$SG181291 DB	0aH, '   addr    ', 00H
	ORG $+3
$SG181295 DB	'%3x', 00H
$SG181296 DB	' | 7 bit ascii. |', 00H
	ORG $+2
$SG181303 DB	0aH, 'Start is %10p, Count is %5x, End is %10p', 00H
	ORG $+2
$SG181308 DB	0aH, '"Enter" to continue.', 0aH, 00H
	ORG $+1
$SG181331 DB	'pp != 0', 00H
	ORG $+4
$SG181332 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
...
; 495  :     for( i = 0 ; i < len ; i++ )  /* Print the hex dump for len
	...
	mov	DWORD PTR _i$181268[ebp], 0
	jmp	SHORT $L181271
$L181272:
	mov	eax, DWORD PTR _i$181268[ebp]
	add	eax, 1
	mov	DWORD PTR _i$181268[ebp], eax
$L181271:
	mov	ecx, DWORD PTR _i$181268[ebp]
...
; 497  :       printf("%3x",(*(ptr+i)&0xff));
	...
	mov	edx, DWORD PTR _ptr$[ebp]
	add	edx, DWORD PTR _i$181268[ebp]
	movsx	eax, BYTE PTR [edx]
	and	eax, 255				; 000000ffH
	push	eax
	push	OFFSET FLAT:$SG181274
	call	_printf
	add	esp, 8
	jmp	SHORT $L181272
$L181273:
...
; 499  :     for( i = len ; i < 16 ; i++ ) /* Pad out the dump field to the
	...
	mov	ecx, DWORD PTR _len$[ebp]
	mov	DWORD PTR _i$181268[ebp], ecx
	jmp	SHORT $L181275
$L181276:
	mov	edx, DWORD PTR _i$181268[ebp]
	add	edx, 1
	mov	DWORD PTR _i$181268[ebp], edx
$L181275:
	cmp	DWORD PTR _i$181268[ebp], 16		; 00000010H
	jge	SHORT $L181277

; 500  :                                      ASCII field. */
; 501  :       printf("   ");

	push	OFFSET FLAT:$SG181278
	call	_printf
	add	esp, 4
	jmp	SHORT $L181276
$L181277:
...
; 505  :       c=0x7f&(*(ptr+i));      /* Mask out bit 7 */
	...
	mov	BYTE PTR _c$181269[ebp], al

; 506  : 
; 507  :       if (!(isprint(c))) {    /* If not printable */

	movsx	ecx, BYTE PTR _c$181269[ebp]
	push	ecx
	call	_isprint
	add	esp, 4
	test	eax, eax
...
; 510  :         printf("%c",c);  }    /* else display it */
	...
	movsx	edx, BYTE PTR _c$181269[ebp]
	push	edx
	push	OFFSET FLAT:$SG181286
	call	_printf
	add	esp, 8
$L181285:
...
; 540  :     for ( i = 0 ; i <= ct ; i = i+16 , ptr = ptr+16 )
	...
	mov	DWORD PTR _i$181302[ebp], 0
	jmp	SHORT $L181305
$L181306:
	mov	ecx, DWORD PTR _i$181302[ebp]
	add	ecx, 16					; 00000010H
	mov	DWORD PTR _i$181302[ebp], ecx
	mov	edx, DWORD PTR _ptr$[ebp]
	add	edx, 16					; 00000010H
	mov	DWORD PTR _ptr$[ebp], edx
$L181305:
	mov	eax, DWORD PTR _i$181302[ebp]
...
; 541  :       ldump(ptr,(MIN(16,(ct-i))));
	...
	mov	ecx, DWORD PTR _ct$[ebp]
	sub	ecx, DWORD PTR _i$181302[ebp]
...
$L181646:
	...
	sub	edx, DWORD PTR _i$181302[ebp]
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlbase.h
xdata$x	SEGMENT
$T181670 DD	0ffffffffH
	DD	FLAT:$L181663
$T181667 DD	019930520H
	DD	01H
	DD	FLAT:$T181670
	DD	2 DUP(00H)
	DD	2 DUP(00H)
