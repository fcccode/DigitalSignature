...
_oid_issuing_disp_point DB 055H
	...
	DB	01cH
	ORG $+1
$SG190714 DB	'ldap:', 00H
	ORG $+2
$SG191507 DB	'pp != 0', 00H
$SG191508 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
...
_TEXT	SEGMENT
$T192335 = -125						; size = 1
_rv$189670 = -124					; size = 4
_realLen$189654 = -120					; size = 4
_pwdBlob$ = -112					; size = 8
_cbData$ = -100						; size = 4
_res$ = -96						; size = 4
...
; 254  : 	int realLen=0;
	...
	mov	DWORD PTR _realLen$189654[ebp], 0
...
$L192336:
	...
	mov	DWORD PTR _realLen$189654[ebp], eax
	cmp	DWORD PTR _realLen$189654[ebp], -1
	jne	SHORT $L189657
...
; 262  : 	pfxBlob.len = realLen;
	...
	mov	edx, DWORD PTR _realLen$189654[ebp]
...
; 337  : 	SECStatus rv = SEC_DeletePermCertificate(pct);
	...
	add	esp, 4
	mov	DWORD PTR _rv$189670[ebp], eax

; 338  :     if (rv != SECSuccess) {

	cmp	DWORD PTR _rv$189670[ebp], 0
	je	SHORT $L189671
...
xdata$x	SEGMENT
$T192392 DD	0ffffffffH
	DD	FLAT:$L192376
	DD	0ffffffffH
	DD	FLAT:$L192377
$T192381 DD	019930520H
	DD	02H
	DD	FLAT:$T192392
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
$T192355 = -260						; size = 4
$T192354 = -256						; size = 4
_crlIndex$190400 = -252					; size = 4
_iList$190399 = -244					; size = 4
_listSize$190394 = -236					; size = 4
_v_issuer$190385 = -232					; size = 4
_v_cert$190384 = -228					; size = 4
_usedCrlList$190372 = -224				; size = 4
_crlIndex$190357 = -220					; size = 4
_iList$190356 = -212					; size = 4
_listSize$190274 = -204					; size = 4
_v_issuer$190264 = -200					; size = 4
_v_cert0$190251 = -196					; size = 4
_v_cert$190246 = -192					; size = 4
_v_issuer$190238 = -188					; size = 4
_v_cert$190237 = -184					; size = 4
_usedCrlList$189790 = -180				; size = 4
_derCert$189754 = -172					; size = 12
_node$189727 = -156					; size = 4
_certUsage$189724 = -152				; size = 4
...
; 505  : 		goto exitCheckCertificate;
	...
	jmp	$exitCheckCertificate$189716
$L189715:
...
; 524  : 		SECCertUsage certUsage = certUsageObjectSigner;
	...
	mov	DWORD PTR _certUsage$189724[ebp], 6
...
; 531  : 			node = log.head;
	...
	mov	DWORD PTR _node$189727[ebp], edx
$L189729:

; 532  : 			while ( node ) {

	cmp	DWORD PTR _node$189727[ebp], 0
	je	SHORT $L189726

; 533  : 				switch (node->error) {

	mov	eax, DWORD PTR _node$189727[ebp]
...
; 556  : 				node = node->next;
	...
	mov	ecx, DWORD PTR _node$189727[ebp]
...
; 586  : 			derCert.len = base64decodeSize(strlen(certVerParams->trustRootCerts[i]));
	...
	call	_base64decodeSize
	add	esp, 4
	mov	DWORD PTR _derCert$189754[ebp+8], eax

; 587  : 			derCert.data = (unsigned char *) zMalloc (derCert.len+1);

	mov	eax, DWORD PTR _derCert$189754[ebp+8]
	add	eax, 1
	push	eax
	call	_malloc
	add	esp, 4
	mov	DWORD PTR _derCert$189754[ebp+4], eax

; 588  : 			if (derCert.data == NULL)

	cmp	DWORD PTR _derCert$189754[ebp+4], 0
	jne	SHORT $L189756
...
; 593  : 			memset(derCert.data,0x00,derCert.len);
	...
	mov	edx, DWORD PTR _derCert$189754[ebp+8]
	push	edx
	push	0
	mov	eax, DWORD PTR _derCert$189754[ebp+4]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
...
; 596  : 				derCert.len);
	...
	mov	ecx, DWORD PTR _derCert$189754[ebp+8]
	push	ecx
	mov	edx, DWORD PTR _derCert$189754[ebp+4]
	push	edx
	mov	eax, DWORD PTR _certVerParams$[ebp]
...
; 597  : 			if (derCert.len == -1) 
	...
	cmp	DWORD PTR _derCert$189754[ebp+8], -1
	jne	SHORT $L189759
...
; 603  : 			if (!(pct = DecodeDERCertificate(&derCert)))
	...
	lea	eax, DWORD PTR _derCert$189754[ebp]
	push	eax
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _pct$[ebp], eax
...
; 718  : 		CrlList *usedCrlList = new CrlList();
	...
	add	esp, 4
	mov	DWORD PTR $T192355[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	cmp	DWORD PTR $T192355[ebp], 0
	je	SHORT $L192356
	mov	ecx, DWORD PTR $T192355[ebp]
...
$L192357:
	...
	mov	DWORD PTR $T192354[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T192354[ebp]
	mov	DWORD PTR _usedCrlList$189790[ebp], ecx
...
; 733  : 				CERTCertificate *v_cert= DecodeDERCertificate(&chain->certs[certIndex]);
	...
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _v_cert$190237[ebp], eax
...
; 734  : 				CERTCertificate *v_issuer= DecodeDERCertificate(&chain->certs[issuerIndex]);
	...
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _v_issuer$190238[ebp], eax

; 735  : 				if (!v_cert || !v_issuer) {

	cmp	DWORD PTR _v_cert$190237[ebp], 0
	je	SHORT $L190240
	cmp	DWORD PTR _v_issuer$190238[ebp], 0
	jne	SHORT $L190239
$L190240:
...
; 748  : 					pg_sig);
	...
	mov	ecx, DWORD PTR _pg_sig$[ebp]
	push	ecx
	mov	edx, DWORD PTR _usedCrlList$189790[ebp]
	push	edx
	...
	mov	ecx, DWORD PTR _pTime$[ebp]
	push	ecx
	mov	edx, DWORD PTR _v_issuer$190238[ebp]
	push	edx
	mov	eax, DWORD PTR _v_cert$190237[ebp]
	push	eax
	mov	ecx, DWORD PTR _handle$[ebp]
	push	ecx
...
; 749  : 				CERT_DestroyCertificate(v_cert);
	...
	mov	edx, DWORD PTR _v_cert$190237[ebp]
	push	edx
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 750  : 				CERT_DestroyCertificate(v_issuer);
	...
	mov	eax, DWORD PTR _v_issuer$190238[ebp]
	push	eax
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 770  : 				CERTCertificate *v_cert= DecodeDERCertificate(&chain->certs[certIndex]);
	...
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _v_cert$190246[ebp], eax

; 771  : 				if (!v_cert) {

	cmp	DWORD PTR _v_cert$190246[ebp], 0
	jne	SHORT $L190247
...
; 775  : 				crlCertUrl = getCRLDist(v_cert);					
	...
	mov	eax, DWORD PTR _v_cert$190246[ebp]
	push	eax
	call	_getCRLDist
	add	esp, 4
...
; 785  : 							CERTCertificate *v_cert0= DecodeDERCertificate(&chain->certs[certIndex-1]);
	...
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _v_cert0$190251[ebp], eax

; 786  : 							if (!v_cert0) {

	cmp	DWORD PTR _v_cert0$190251[ebp], 0
	jne	SHORT $L190252
...
; 790  : 							crlCertUrl = getCRLDist(v_cert0);
	...
	mov	edx, DWORD PTR _v_cert0$190251[ebp]
	push	edx
	call	_getCRLDist
	add	esp, 4
	mov	DWORD PTR _crlCertUrl$[ebp], eax
...
; 791  : 							CERT_DestroyCertificate(v_cert0);
	...
	mov	eax, DWORD PTR _v_cert0$190251[ebp]
	push	eax
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 797  : 								CERT_DestroyCertificate(v_cert);
	...
	mov	edx, DWORD PTR _v_cert$190246[ebp]
	push	edx
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 831  : 				CERTCertificate *v_issuer= DecodeDERCertificate(&chain->certs[issuerIndex]);
	...
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _v_issuer$190264[ebp], eax

; 832  : 
; 833  : 				if (!v_issuer) {

	cmp	DWORD PTR _v_issuer$190264[ebp], 0
	jne	SHORT $L190265
...
; 848  : 					pg_sig);
	...
	mov	eax, DWORD PTR _pg_sig$[ebp]
	push	eax
	mov	ecx, DWORD PTR _usedCrlList$189790[ebp]
	push	ecx
	...
	mov	eax, DWORD PTR _pTime$[ebp]
	push	eax
	mov	ecx, DWORD PTR _v_issuer$190264[ebp]
	push	ecx
	mov	edx, DWORD PTR _v_cert$190246[ebp]
	push	edx
...
; 849  : 				CERT_DestroyCertificate(v_cert);
	...
	mov	ecx, DWORD PTR _v_cert$190246[ebp]
	push	ecx
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 850  : 				CERT_DestroyCertificate(v_issuer);
	...
	mov	edx, DWORD PTR _v_issuer$190264[ebp]
	push	edx
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 884  : 		unsigned int listSize = usedCrlList->size();
	...
	mov	DWORD PTR _listSize$190274[ebp], eax

; 885  : 		if (listSize != 0)

	cmp	DWORD PTR _listSize$190274[ebp], 0
	je	$L190275
...
; 887  : 			certVerParams->usedCrlCount = listSize;
	...
	mov	eax, DWORD PTR _certVerParams$[ebp]
	mov	ecx, DWORD PTR _listSize$190274[ebp]
	mov	DWORD PTR [eax+60], ecx

; 888  : 			certVerParams->usedCrlList = (LPSTR *) zMalloc(listSize * sizeof(LPSTR *));

	mov	edx, DWORD PTR _listSize$190274[ebp]
	shl	edx, 2
	push	edx
	call	_malloc
	add	esp, 4
...
; 890  : 			CrlList::iterator iList;
	...
	lea	ecx, DWORD PTR _iList$190356[ebp]
...
$L190362:
	push	0
	lea	edx, DWORD PTR $T192360[ebp]
	push	edx
	lea	ecx, DWORD PTR _iList$190356[ebp]
	call	??Fiterator@?$list@PAEV?$allocator@PAE@std@@@std@@QAE?AV012@H@Z ; std::list<unsigned char *,std::allocator<unsigned char *> >::iterator::operator--
	mov	eax, DWORD PTR _crlIndex$190357[ebp]
	add	eax, 1
	mov	DWORD PTR _crlIndex$190357[ebp], eax
$L190361:
	mov	ecx, DWORD PTR _crlIndex$190357[ebp]
	cmp	ecx, DWORD PTR _listSize$190274[ebp]
	jae	SHORT $L190275
...
; 895  : 				strcpy((char *)certVerParams->usedCrlList[crlIndex], (const char *)*iList);
	...
	mov	eax, DWORD PTR _certVerParams$[ebp]
	mov	ecx, DWORD PTR [eax+64]
	mov	edx, DWORD PTR _crlIndex$190357[ebp]
	mov	eax, DWORD PTR [ecx+edx*4]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 900  : 		delete usedCrlList;
	...
	mov	edx, DWORD PTR _usedCrlList$189790[ebp]
	mov	DWORD PTR $T192362[ebp], edx
	mov	eax, DWORD PTR $T192362[ebp]
	mov	DWORD PTR $T192361[ebp], eax
	cmp	DWORD PTR $T192361[ebp], 0
	je	SHORT $L192363
	push	1
	mov	ecx, DWORD PTR $T192361[ebp]
...
; 904  : 		if (certVerParams->verificationOptions & VERIFY_CRL_REC)
	...
	je	$exitCheckCertificate$189716
...
; 906  : 			CrlList *usedCrlList = new CrlList();
	...
	call	??2@YAPAXI@Z				; operator new
	add	esp, 4
	mov	DWORD PTR $T192366[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], 1
	cmp	DWORD PTR $T192366[ebp], 0
	je	SHORT $L192367
	mov	ecx, DWORD PTR $T192366[ebp]
	call	??0?$list@PAEV?$allocator@PAE@std@@@std@@QAE@XZ ; std::list<unsigned char *,std::allocator<unsigned char *> >::list<unsigned char *,std::allocator<unsigned char *> >
...
$L192368:
	...
	mov	DWORD PTR $T192365[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	mov	ecx, DWORD PTR $T192365[ebp]
	mov	DWORD PTR _usedCrlList$190372[ebp], ecx
...
; 919  : 					CERTCertificate *v_cert= DecodeDERCertificate(&chain->certs[certIndex]);
	...
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _v_cert$190384[ebp], eax
...
; 920  : 					CERTCertificate *v_issuer= DecodeDERCertificate(&chain->certs[issuerIndex]);
	...
	call	_DecodeDERCertificate
	add	esp, 4
	mov	DWORD PTR _v_issuer$190385[ebp], eax

; 921  : 
; 922  : 					if (!v_cert || !v_issuer) {

	cmp	DWORD PTR _v_cert$190384[ebp], 0
	je	SHORT $L190387
	cmp	DWORD PTR _v_issuer$190385[ebp], 0
	jne	SHORT $L190386
$L190387:
...
; 935  : 						pg_sig);
	...
	mov	ecx, DWORD PTR _pg_sig$[ebp]
	push	ecx
	mov	edx, DWORD PTR _usedCrlList$190372[ebp]
	push	edx
	lea	eax, DWORD PTR _crlFound$[ebp]
	push	eax
	push	1
	...
	mov	ecx, DWORD PTR _pTime$[ebp]
	push	ecx
	mov	edx, DWORD PTR _v_issuer$190385[ebp]
	push	edx
	mov	eax, DWORD PTR _v_cert$190384[ebp]
	push	eax
	mov	ecx, DWORD PTR _handle$[ebp]
	push	ecx
	call	?check_CRL@@YAHPAUNSSTrustDomainStr@@PAUCERTCertificateStr@@1_JPAPADIHPAHPAV?$list@PAEV?$allocator@PAE@std@@@std@@PAU_GLOBAL_SIG@@@Z ; check_CRL
...
; 936  : 					CERT_DestroyCertificate(v_cert);
	...
	mov	edx, DWORD PTR _v_cert$190384[ebp]
	push	edx
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 937  : 					CERT_DestroyCertificate(v_issuer);
	...
	mov	eax, DWORD PTR _v_issuer$190385[ebp]
	push	eax
	call	_CERT_DestroyCertificate
	add	esp, 4
...
; 965  : 				unsigned int listSize = usedCrlList->size();
	...
	mov	ecx, DWORD PTR _usedCrlList$190372[ebp]
	call	?size@?$list@PAEV?$allocator@PAE@std@@@std@@QBEIXZ ; std::list<unsigned char *,std::allocator<unsigned char *> >::size
	mov	DWORD PTR _listSize$190394[ebp], eax

; 966  : 				if (listSize != 0)

	cmp	DWORD PTR _listSize$190394[ebp], 0
	je	$L190377
...
; 968  : 					certVerParams->usedCrlCount = listSize;
	...
	mov	ecx, DWORD PTR _certVerParams$[ebp]
	mov	edx, DWORD PTR _listSize$190394[ebp]
	mov	DWORD PTR [ecx+60], edx

; 969  : 					certVerParams->usedCrlList = (LPSTR *) zMalloc(listSize * sizeof(LPSTR *));

	mov	eax, DWORD PTR _listSize$190394[ebp]
	shl	eax, 2
	push	eax
	call	_malloc
	add	esp, 4
...
; 971  : 					CrlList::iterator iList;
	...
	lea	ecx, DWORD PTR _iList$190399[ebp]
	call	??0iterator@?$list@PAEV?$allocator@PAE@std@@@std@@QAE@XZ ; std::list<unsigned char *,std::allocator<unsigned char *> >::iterator::iterator

; 972  : 					unsigned int crlIndex=0;

	mov	DWORD PTR _crlIndex$190400[ebp], 0

; 973  : 					for (iList = usedCrlList->end(), iList--; crlIndex < listSize; iList--, crlIndex++)

	lea	edx, DWORD PTR $T192369[ebp]
	push	edx
	mov	ecx, DWORD PTR _usedCrlList$190372[ebp]
	call	?end@?$list@PAEV?$allocator@PAE@std@@@std@@QAE?AViterator@12@XZ ; std::list<unsigned char *,std::allocator<unsigned char *> >::end
	mov	eax, DWORD PTR [eax]
	mov	DWORD PTR _iList$190399[ebp], eax
	push	0
	lea	ecx, DWORD PTR $T192370[ebp]
	push	ecx
	lea	ecx, DWORD PTR _iList$190399[ebp]
	call	??Fiterator@?$list@PAEV?$allocator@PAE@std@@@std@@QAE?AV012@H@Z ; std::list<unsigned char *,std::allocator<unsigned char *> >::iterator::operator--
	jmp	SHORT $L190404
$L190405:
	push	0
	lea	edx, DWORD PTR $T192371[ebp]
	push	edx
	lea	ecx, DWORD PTR _iList$190399[ebp]
	call	??Fiterator@?$list@PAEV?$allocator@PAE@std@@@std@@QAE?AV012@H@Z ; std::list<unsigned char *,std::allocator<unsigned char *> >::iterator::operator--
	mov	eax, DWORD PTR _crlIndex$190400[ebp]
	add	eax, 1
	mov	DWORD PTR _crlIndex$190400[ebp], eax
$L190404:
	mov	ecx, DWORD PTR _crlIndex$190400[ebp]
	cmp	ecx, DWORD PTR _listSize$190394[ebp]
	jae	SHORT $L190377
...
; 976  : 						strcpy((char *)certVerParams->usedCrlList[crlIndex], (const char *)*iList);
	...
	mov	eax, DWORD PTR _certVerParams$[ebp]
	mov	ecx, DWORD PTR [eax+64]
	mov	edx, DWORD PTR _crlIndex$190400[ebp]
	mov	eax, DWORD PTR [ecx+edx*4]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 982  : 			delete usedCrlList;
	...
	mov	edx, DWORD PTR _usedCrlList$190372[ebp]
	mov	DWORD PTR $T192373[ebp], edx
	mov	eax, DWORD PTR $T192373[ebp]
	mov	DWORD PTR $T192372[ebp], eax
	cmp	DWORD PTR $T192372[ebp], 0
	je	SHORT $L192374
	push	1
	mov	ecx, DWORD PTR $T192372[ebp]
	call	??_G?$list@PAEV?$allocator@PAE@std@@@std@@QAEPAXI@Z
	mov	DWORD PTR tv625[ebp], eax
	jmp	SHORT $exitCheckCertificate$189716
$L192374:
	mov	DWORD PTR tv625[ebp], 0
$exitCheckCertificate$189716:
...
xdata$x	SEGMENT
$T192412 DD	0ffffffffH
	DD	FLAT:$L192400
$T192402 DD	019930520H
	DD	01H
	DD	FLAT:$T192412
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
$T192398 = -196						; size = 4
$T192397 = -192						; size = 4
_entry$190759 = -188					; size = 4
_b64Crl$190754 = -180					; size = 4
_size$190753 = -172					; size = 4
_encodedExt$190746 = -164				; size = 12
_oid2$190745 = -144					; size = 12
_oid1$190744 = -124					; size = 12
_extensions$190743 = -108				; size = 4
_cName$190736 = -104					; size = 4
_sCrl$190733 = -100					; size = 4
_i$190729 = -96						; size = 4
_pds$190723 = -92					; size = 4
_i$190716 = -88						; size = 4
_pCrl$190715 = -84					; size = 4
...
; 1623 : 					PDS_DATA_BLOB *pCrl = fetchLDAP_URL(crlUrl);
	...
	call	_fetchLDAP_URL
	add	esp, 4
	mov	DWORD PTR _pCrl$190715[ebp], eax

; 1624 : 					int i=0;

	mov	DWORD PTR _i$190716[ebp], 0
$L190718:

; 1625 : 					while (pCrl && pCrl[i]) {

	cmp	DWORD PTR _pCrl$190715[ebp], 0
	je	SHORT $L190719
	mov	eax, DWORD PTR _i$190716[ebp]
	mov	ecx, DWORD PTR _pCrl$190715[ebp]
...
; 1627 : 						crl->data = pCrl[i]->pbData;
	...
	mov	edx, DWORD PTR _i$190716[ebp]
	mov	eax, DWORD PTR _pCrl$190715[ebp]
	mov	ecx, DWORD PTR [eax+edx*4]
	mov	edx, DWORD PTR _crl$[ebp]
...
; 1628 : 						crl->len = pCrl[i]->cbData;
	...
	mov	ecx, DWORD PTR _i$190716[ebp]
	mov	edx, DWORD PTR _pCrl$190715[ebp]
	mov	eax, DWORD PTR [edx+ecx*4]
	mov	ecx, DWORD PTR _crl$[ebp]
...
; 1630 : 						i++;
	...
	mov	ecx, DWORD PTR _i$190716[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$190716[ebp], ecx
...
; 1636 : 					PDS_DATA_BLOB pds=NULL;
	...
	mov	DWORD PTR _pds$190723[ebp], 0
...
; 1637 : 					pds = fetch_URL(crlUrl);
	...
	call	_fetch_URL
	add	esp, 4
	mov	DWORD PTR _pds$190723[ebp], eax

; 1638 : 					if (pds) {

	cmp	DWORD PTR _pds$190723[ebp], 0
	je	SHORT $L190724
...
; 1640 : 						crl->data = pds->pbData;
	...
	mov	ecx, DWORD PTR _crl$[ebp]
	mov	edx, DWORD PTR _pds$190723[ebp]
...
; 1660 : 		for (UINT i=0; i<crlBlobList.size(); i++) 
	...
	mov	DWORD PTR _i$190729[ebp], 0
	jmp	SHORT $L190730
$L190731:
	mov	eax, DWORD PTR _i$190729[ebp]
	add	eax, 1
	mov	DWORD PTR _i$190729[ebp], eax
$L190730:
	lea	ecx, DWORD PTR _crlBlobList$[ebp]
	call	?size@?$vector@PAUSECItemStr@@V?$allocator@PAUSECItemStr@@@std@@@std@@QBEIXZ ; std::vector<SECItemStr *,std::allocator<SECItemStr *> >::size
	cmp	DWORD PTR _i$190729[ebp], eax
	jae	$L190732

; 1661 : 		{
; 1662 : 			crl = crlBlobList.at(i);

	mov	ecx, DWORD PTR _i$190729[ebp]
	push	ecx
	lea	ecx, DWORD PTR _crlBlobList$[ebp]
...
; 1665 : 				CERT_DecodeDERCrl(NULL,crl,SEC_CRL_TYPE);
	...
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _sCrl$190733[ebp], eax

; 1666 : 			if (sCrl==NULL) 

	cmp	DWORD PTR _sCrl$190733[ebp], 0
	jne	SHORT $L190734
...
; 1680 : 			pCrlContext = &(sCrl->crl);
	...
	mov	ecx, DWORD PTR _sCrl$190733[ebp]
	add	ecx, 4
...
; 1681 : 			BYTE *cName = (BYTE *) CERT_NameToAscii(&pCrlContext->name);
	...
	add	esp, 4
	mov	DWORD PTR _cName$190736[ebp], eax
...
; 1685 : 					== TRUE) // certificate and CRL issuers match
	...
	mov	eax, DWORD PTR _cName$190736[ebp]
	push	eax
...
; 1692 : 				       pg_sig);
	...
	push	ecx
	mov	edx, DWORD PTR _sCrl$190733[ebp]
...
; 1710 : 					CERTCertExtension **extensions = pCrlContext->extensions;
	...
	mov	DWORD PTR _extensions$190743[ebp], edx
...
; 1714 : 					oid1.data = (BYTE *) oid_delta_crl_idicator;
	...
	mov	DWORD PTR _oid1$190744[ebp+4], OFFSET FLAT:_oid_delta_crl_idicator

; 1715 : 					oid1.len = 3;

	mov	DWORD PTR _oid1$190744[ebp+8], 3

; 1716 : 					oid2.data = (BYTE *) oid_issuing_disp_point;

	mov	DWORD PTR _oid2$190745[ebp+4], OFFSET FLAT:_oid_issuing_disp_point

; 1717 : 					oid2.len = 3;

	mov	DWORD PTR _oid2$190745[ebp+8], 3

; 1718 : 
; 1719 : 					encodedExt.data = NULL;

	mov	DWORD PTR _encodedExt$190746[ebp+4], 0

; 1720 : 					encodedExt.len =0;

	mov	DWORD PTR _encodedExt$190746[ebp+8], 0
...
; 1726 : 					ss = i_cert_FindExtensionByOID(extensions,&oid1,&encodedExt);
	...
	lea	ecx, DWORD PTR _encodedExt$190746[ebp]
	push	ecx
	lea	edx, DWORD PTR _oid1$190744[ebp]
	push	edx
	mov	eax, DWORD PTR _extensions$190743[ebp]
	push	eax
...
; 1727 : 					if ((ss == SECSuccess) && (encodedExt.len>0))
	...
	cmp	DWORD PTR _ss$[ebp], 0
	jne	SHORT $L190749
	cmp	DWORD PTR _encodedExt$190746[ebp+8], 0
	jbe	SHORT $L190749
...
; 1733 : 						SEC_DestroyCrl(sCrl);
	...
	mov	eax, DWORD PTR _sCrl$190733[ebp]
	push	eax
	call	_SEC_DestroyCrl
	add	esp, 4
...
; 1743 : 					ss = i_cert_FindExtensionByOID(extensions,&oid2,&encodedExt);
	...
	lea	edx, DWORD PTR _encodedExt$190746[ebp]
	push	edx
	lea	eax, DWORD PTR _oid2$190745[ebp]
	push	eax
	mov	ecx, DWORD PTR _extensions$190743[ebp]
	push	ecx
	call	_i_cert_FindExtensionByOID
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _ss$[ebp], eax
...
; 1760 : 					int size = base64encodeSize(crl->len);
	...
	add	esp, 4
	mov	DWORD PTR _size$190753[ebp], eax

; 1761 : 					unsigned char *b64Crl = (unsigned char *)zMalloc(size+1);

	mov	edx, DWORD PTR _size$190753[ebp]
	add	edx, 1
	push	edx
	call	_malloc
	add	esp, 4
	mov	DWORD PTR _b64Crl$190754[ebp], eax

; 1762 : 					if ((size = base64encode(crl->data, crl->len, b64Crl, size+1)) == -1)

	mov	eax, DWORD PTR _size$190753[ebp]
	add	eax, 1
	push	eax
	mov	ecx, DWORD PTR _b64Crl$190754[ebp]
	push	ecx
	mov	edx, DWORD PTR _crl$[ebp]
	mov	eax, DWORD PTR [edx+8]
	push	eax
	...
	mov	DWORD PTR _size$190753[ebp], eax
	cmp	DWORD PTR _size$190753[ebp], -1
	jne	SHORT $L190756
...
; 1768 : 					*(b64Crl + size) = '\0';
	...
	mov	edx, DWORD PTR _b64Crl$190754[ebp]
	add	edx, DWORD PTR _size$190753[ebp]
	mov	BYTE PTR [edx], 0

; 1769 : 					usedCrlList->insert(usedCrlList->begin(), b64Crl);

	lea	eax, DWORD PTR _b64Crl$190754[ebp]
	push	eax
	lea	ecx, DWORD PTR $T192397[ebp]
	push	ecx
...
; 1770 : 					CERTCrlEntry *entry = FindCertInCRL(pCertContext, pCrlContext);
	...
	call	_FindCertInCRL
	add	esp, 8
	mov	DWORD PTR _entry$190759[ebp], eax

; 1771 : 					if (entry != NULL) {

	cmp	DWORD PTR _entry$190759[ebp], 0
	je	$L190742
...
; 1774 : 						if (CompareCRLTime(&entry->revocationDate, pTime) <= 0)
	...
	mov	ecx, DWORD PTR _pTime$[ebp]
	push	ecx
	mov	edx, DWORD PTR _entry$190759[ebp]
...
; 1816 : 				PORT_Free(cName);
	...
	mov	ecx, DWORD PTR _cName$190736[ebp]
	push	ecx
	call	_PORT_Free
	add	esp, 4
...
; 545  : 		return (*(begin() + _Pos));
	...
	push	eax
	lea	ecx, DWORD PTR $T192467[ebp]
	push	ecx
	lea	edx, DWORD PTR $T192466[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T192537 DD	0ffffffffH
	DD	FLAT:$L192533
$T192535 DD	019930520H
	DD	01H
	DD	FLAT:$T192537
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 889  : 		_THROW(out_of_range, "invalid vector<T> subscript");
	...
	lea	ecx, DWORD PTR $T192532[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	lea	eax, DWORD PTR $T192532[ebp]
	push	eax
	lea	ecx, DWORD PTR $T192531[ebp]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T192550 DD	0ffffffffH
	DD	FLAT:$L192545
$T192548 DD	019930520H
	DD	01H
	DD	FLAT:$T192550
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T192564 DD	0ffffffffH
	DD	FLAT:$L192559
$T192562 DD	019930520H
	DD	01H
	DD	FLAT:$T192564
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 1514 : 			_Elem *_Ptr = _Bx._Ptr;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR __Ptr$191131[ebp], eax
...
; 1516 : 				_Traits::copy(_Bx._Buf, _Ptr, _Newsize);
	...
	push	ecx
	mov	edx, DWORD PTR __Ptr$191131[ebp]
	push	edx
	mov	eax, DWORD PTR _this$[ebp]
	add	eax, 4
	push	eax
...
; 1517 : 			_Mybase::_Alval.deallocate(_Ptr, _Myres + 1);
	...
	add	edx, 1
	push	edx
	mov	eax, DWORD PTR __Ptr$191131[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T192614 DD	0ffffffffH
	DD	FLAT:$L192609
$T192612 DD	019930520H
	DD	01H
	DD	FLAT:$T192614
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 801  : 			size_type _Newsize = _Mysize - _Count;
	...
	mov	DWORD PTR __Newsize$191260[ebp], eax

; 802  : 			_Eos(_Newsize);

	mov	ecx, DWORD PTR __Newsize$191260[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Eos@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@IAEXI@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Eos
$L191259:
...
; 1475 : 		_Traits::assign(_Myptr()[_Mysize = _Newsize], _Elem());
	...
	mov	BYTE PTR $T192628[ebp], 0
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR __Newsize$[ebp]
	mov	DWORD PTR [eax+20], ecx
	lea	edx, DWORD PTR $T192628[ebp]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Myptr@?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAEPADXZ ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::_Myptr
...
; 920  : 		new ((void *)_Pnode) _Node(_Next, _Prev, _Val);
	...
	add	esp, 8
	mov	DWORD PTR $T192650[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 1
	cmp	DWORD PTR $T192650[ebp], 0
	je	SHORT $L192651
	mov	ecx, DWORD PTR __Val$[ebp]
	push	ecx
...
; File c:\program files\microsoft visual studio .net 2003\vc7\include\list
xdata$x	SEGMENT
$T192676 DD	0ffffffffH
	DD	FLAT:$L192672
$T192674 DD	019930520H
	DD	01H
	DD	FLAT:$T192676
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 958  : 			_THROW(length_error, "list<T> too long");
	...
	lea	ecx, DWORD PTR $T192671[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	lea	edx, DWORD PTR $T192671[ebp]
	push	edx
	lea	ecx, DWORD PTR $T192670[ebp]
...
tv239 = -56						; size = 4
tv85 = -52						; size = 4
__Oldend$191390 = -48					; size = 4
__Ptr$191370 = -44					; size = 4
__Newvec$191369 = -40					; size = 4
...
; 823  : 			pointer _Newvec = this->_Alval.allocate(_Capacity);
	...
	mov	ecx, DWORD PTR _this$[ebp]
	call	?allocate@?$allocator@PAUSECItemStr@@@std@@QAEPAPAUSECItemStr@@I@Z ; std::allocator<SECItemStr *>::allocate
	mov	DWORD PTR __Newvec$191369[ebp], eax

; 824  : 			pointer _Ptr = _Newvec;

	mov	edx, DWORD PTR __Newvec$191369[ebp]
	mov	DWORD PTR __Ptr$191370[ebp], edx
...
; 828  : 				_Newvec);	// copy prefix
	...
	mov	eax, DWORD PTR __Newvec$191369[ebp]
	push	eax
	mov	ecx, DWORD PTR __Where$[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
	...
	mov	DWORD PTR __Ptr$191370[ebp], ecx
...
; 829  : 			_Ptr = _Ufill(_Ptr, _Count, _Tmp);	// add new stuff
	...
	mov	eax, DWORD PTR __Count$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Ptr$191370[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?_Ufill@?$vector@PAUSECItemStr@@V?$allocator@PAUSECItemStr@@@std@@@std@@IAEPAPAUSECItemStr@@PAPAU3@IABQAU3@@Z ; std::vector<SECItemStr *,std::allocator<SECItemStr *> >::_Ufill
...
; 830  : 			_Ucopy(_ITER_BASE(_Where), _Mylast, _Ptr);	// copy suffix
	...
	mov	eax, DWORD PTR __Ptr$191370[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	push	edx
...
; 833  : 			this->_Alval.deallocate(_Newvec, _Capacity);
	...
	mov	eax, DWORD PTR __Capacity$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Newvec$191369[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?deallocate@?$allocator@PAUSECItemStr@@@std@@QAEXPAPAUSECItemStr@@I@Z ; std::allocator<SECItemStr *>::deallocate
...
; 866  : 			pointer _Oldend = _Mylast;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR [edx+8]
	mov	DWORD PTR __Oldend$191390[ebp], eax
...
; 868  : 				_Mylast);	// copy suffix
	...
	mov	edx, DWORD PTR [ecx+8]
	push	edx
	mov	eax, DWORD PTR __Oldend$191390[ebp]
	push	eax
	mov	ecx, DWORD PTR __Count$[ebp]
	shl	ecx, 2
	mov	edx, DWORD PTR __Oldend$191390[ebp]
	sub	edx, ecx
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	??$_Ucopy@PAPAUSECItemStr@@@?$vector@PAUSECItemStr@@V?$allocator@PAUSECItemStr@@@std@@@std@@IAEPAPAUSECItemStr@@PAPAU2@00@Z ; std::vector<SECItemStr *,std::allocator<SECItemStr *> >::_Ucopy<SECItemStr * *>
...
; 870  : 				_Oldend);	// copy hole
	...
	mov	eax, DWORD PTR __Count$[ebp]
	shl	eax, 2
	mov	ecx, DWORD PTR __Oldend$191390[ebp]
	sub	ecx, eax
	push	ecx
	mov	edx, DWORD PTR __Where$[ebp]
	push	edx
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T192738 DD	0ffffffffH
	DD	FLAT:$L192734
$T192736 DD	019930520H
	DD	01H
	DD	FLAT:$T192738
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 884  : 		_THROW(length_error, "vector<T> too long");
	...
	lea	ecx, DWORD PTR $T192733[ebp]
	call	??0?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@std@@QAE@PBD@Z ; std::basic_string<char,std::char_traits<char>,std::allocator<char> >::basic_string<char,std::char_traits<char>,std::allocator<char> >
	mov	DWORD PTR __$EHRec$[ebp+8], 0
	lea	eax, DWORD PTR $T192733[ebp]
	push	eax
	lea	ecx, DWORD PTR $T192732[ebp]
	call	??0length_error@std@@QAE@ABV?$basic_string@DU?$char_traits@D@std@@V?$allocator@D@2@@1@@Z ; std::length_error::length_error
	push	OFFSET FLAT:__TI3?AVlength_error@std@@
	lea	ecx, DWORD PTR $T192732[ebp]
	push	ecx
...
; 279  : 			return ((const_iterator)*this - _Right);
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	ecx, DWORD PTR [eax]
	mov	DWORD PTR $T192753[ebp], ecx
	mov	edx, DWORD PTR __Right$[ebp]
	push	edx
	lea	ecx, DWORD PTR $T192753[ebp]
...
; 257  : 		_Ptr_cat(_First, _First));
	...
	add	esp, 8
	mov	BYTE PTR $T192816[ebp], al
	mov	dl, BYTE PTR $T192816[ebp]
	push	edx
...
; 42   : 	new ((void _FARQ *)_Ptr) _T1(_Val);
	...
	call	??2@YAPAXIPAX@Z				; operator new
	add	esp, 8
	mov	DWORD PTR $T192823[ebp], eax
	cmp	DWORD PTR $T192823[ebp], 0
	je	SHORT $L192824
	mov	ecx, DWORD PTR $T192823[ebp]
	mov	edx, DWORD PTR __Val$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR [ecx], eax
	mov	ecx, DWORD PTR $T192823[ebp]
...
; 217  : 	_Destroy_range(_First, _Last, _Al, _Ptr_cat(_First, _Last));
	...
	call	??$_Ptr_cat@USECItemStr@@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAUSECItemStr@@0@Z ; std::_Ptr_cat<SECItemStr>
	add	esp, 8
	mov	BYTE PTR $T192830[ebp], al
	mov	dl, BYTE PTR $T192830[ebp]
	push	edx
	mov	eax, DWORD PTR __Al$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 1069 : 		_Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@USECItemStr@@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAUSECItemStr@@0@Z ; std::_Ptr_cat<SECItemStr>
	add	esp, 8
	mov	BYTE PTR $T192837[ebp], al
	mov	dl, BYTE PTR $T192837[ebp]
	push	edx
	mov	eax, DWORD PTR __Dest$[ebp]
	push	eax
	mov	ecx, DWORD PTR __Last$[ebp]
...
; 128  : 		_Ptr_cat(_First, _Dest)));
	...
	call	??$_Ptr_cat@USECItemStr@@@std@@YA?AU_Scalar_ptr_iterator_tag@0@PAPAUSECItemStr@@0@Z ; std::_Ptr_cat<SECItemStr>
	add	esp, 8
	mov	BYTE PTR $T192857[ebp], al
	mov	dl, BYTE PTR $T192857[ebp]
	push	edx
	mov	eax, DWORD PTR __Al$[ebp]
	push	eax
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlbase.h
xdata$x	SEGMENT
$T192884 DD	0ffffffffH
	DD	FLAT:$L192880
$T192882 DD	019930520H
	DD	01H
	DD	FLAT:$T192884
	DD	2 DUP(00H)
	DD	2 DUP(00H)
