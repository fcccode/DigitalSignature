========================================================================
    ACTIVE TEMPLATE LIBRARY : PemUtil Project Overview
========================================================================

AppWizard has created this PemUtil project for you to use as the starting point for
...
_PemUtil.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_PemUtil.h)
        GUID definitions                                (_PemUtil_i.c)
        A type library                                  (_PemUtil.tlb)
        Marshaling code                                 (_PemUtil_p.c and dlldata.c)
PemUtil.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named PemUtil.pch and a precompiled types file named StdAfx.obj.
...
PemUtilps.vcproj
	...
	dlldata.c, PemUtil_i.c and PemUtil_p.c which are required
