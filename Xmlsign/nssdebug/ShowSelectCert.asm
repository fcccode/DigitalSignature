...
CONST	ENDS
CONST	SEGMENT
$SG197632 DB	'Invalid DateTime', 00H
CONST	ENDS
;	COMDAT ?szInvalidDateTime@ATL@@3QBDB
CONST	SEGMENT
?szInvalidDateTime@ATL@@3QBDB DD FLAT:$SG197632		; ATL::szInvalidDateTime
CONST	ENDS
CONST	SEGMENT
	ORG $+3
$SG197634 DB	'Invalid DateTimeSpan', 00H
CONST	ENDS
;	COMDAT ?szInvalidDateTimeSpan@ATL@@3QBDB
CONST	SEGMENT
?szInvalidDateTimeSpan@ATL@@3QBDB DD FLAT:$SG197634	; ATL::szInvalidDateTimeSpan
CONST	ENDS
;	COMDAT ?licenseTimeout@CLicense@@0HB
CONST	SEGMENT
...
$SG204009 DB	' ', 00H
	ORG $+2
$SG205487 DB	'pThis != 0', 00H
	ORG $+5
$SG205488 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
	DB	'tlmfc\include\atlwin.h', 00H
	ORG $+1
$SG205498 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
	DB	'tlmfc\include\atlwin.h', 00H
	ORG $+1
$SG205499 DB	'Subclassing through a hook discarded.', 0aH, 00H
	ORG $+1
$SG205505 DB	'pp != 0', 00H
$SG205506 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T206975 DD	0ffffffffH
	DD	FLAT:$L206962
	DD	00H
	DD	FLAT:$L206963
$T206967 DD	019930520H
	DD	02H
	DD	FLAT:$T206975
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207002 DD	0ffffffffH
	DD	FLAT:$L206994
$T206996 DD	019930520H
	DD	01H
	DD	FLAT:$T207002
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 341  :                    EXCEPTION_CONTINUE_SEARCH)
	...
	mov	DWORD PTR $T207012[ebp], eax
	mov	eax, DWORD PTR $T207012[ebp]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207058 DD	0ffffffffH
	DD	FLAT:$L207050
$T207052 DD	019930520H
	DD	01H
	DD	FLAT:$T207058
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 235  : 	return ::GetStringTypeExA(lcid, dwInfoType, pszA, nLengthA, pwCharType);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T207049[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _pszA$[ebp]
	call	??1?$CTempBuffer@D$0IA@VCCRTAllocator@ATL@@@ATL@@QAE@XZ ; ATL::CTempBuffer<char,128,ATL::CCRTAllocator>::~CTempBuffer<char,128,ATL::CCRTAllocator>
	mov	eax, DWORD PTR $T207049[ebp]
...
; 41   : 	for (int i=0; i<count; i++)
	...
	mov	DWORD PTR _i$203994[ebp], 0
	jmp	SHORT $L203995
$L203996:
	mov	eax, DWORD PTR _i$203994[ebp]
	add	eax, 1
	mov	DWORD PTR _i$203994[ebp], eax
$L203995:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _i$203994[ebp]
...
; 54   : 		for(int j=dwSizeBuf;j>0;j--){
	...
	mov	ecx, DWORD PTR _dwSizeBuf$[ebp]
	mov	DWORD PTR _j$204003[ebp], ecx
	jmp	SHORT $L204004
$L204005:
	mov	edx, DWORD PTR _j$204003[ebp]
	sub	edx, 1
	mov	DWORD PTR _j$204003[ebp], edx
$L204004:
	cmp	DWORD PTR _j$204003[ebp], 0
	jle	SHORT $L204006

; 55   : 			sprintf(s,"%02x",(int)buff[j-1]);

	mov	eax, DWORD PTR _buff$[ebp]
	add	eax, DWORD PTR _j$204003[ebp]
	movzx	ecx, BYTE PTR [eax-1]
	push	ecx
	push	OFFSET FLAT:$SG204008
...
; 65   : 		issuer[i] = (WCHAR *)cV[i]->issuer;
	...
	mov	ecx, DWORD PTR _i$203994[ebp]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207114 DD	0ffffffffH
	DD	FLAT:$L207107
$T207109 DD	019930520H
	DD	01H
	DD	FLAT:$T207114
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 80   : 			for(int i=0;i<count;i++){		
	...
	mov	DWORD PTR _i$177680[ebp], 0
	jmp	SHORT $L177681
$L177682:
	mov	eax, DWORD PTR _i$177680[ebp]
	add	eax, 1
	mov	DWORD PTR _i$177680[ebp], eax
$L177681:
	mov	ecx, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR _i$177680[ebp]
	cmp	edx, DWORD PTR [ecx+64]
	jge	$L177683
...
; 84   : 				tmpBstr = A2WBSTR((LPCSTR)notAfter[i]);
	...
	add	esp, 8
	mov	DWORD PTR _tmpBstr$177686[ebp], eax
...
; 85   : 				SetCell((LPWSTR)tmpBstr,i,2);
	...
	mov	edx, DWORD PTR _i$177680[ebp]
	push	edx
	mov	eax, DWORD PTR _tmpBstr$177686[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
	call	?SetCell@CShowSelectCert@@QAEXPAGHH@Z	; CShowSelectCert::SetCell
...
; 86   : 				SysFreeString(tmpBstr);
	...
	mov	esi, esp
	mov	ecx, DWORD PTR _tmpBstr$177686[ebp]
	push	ecx
...
; 87   : 				tmpBstr = A2WBSTR((LPCSTR)decodedDataPtr[i]);
	...
	mov	ecx, DWORD PTR _i$177680[ebp]
	mov	edx, DWORD PTR [eax+ecx*4]
	push	edx
	call	?A2WBSTR@@YAPAGPBDH@Z			; A2WBSTR
	add	esp, 8
...
; 89   : 				SysFreeString(tmpBstr);
	...
	mov	esi, esp
	mov	edx, DWORD PTR _tmpBstr$177686[ebp]
	push	edx
	call	DWORD PTR __imp__SysFreeString@4
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; 97   : 		return 1;  // Let the system set the focus
	...
	mov	DWORD PTR $T207106[ebp], 1
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _caption$[ebp]
	call	??1CComBSTR@ATL@@QAE@XZ			; ATL::CComBSTR::~CComBSTR
	mov	eax, DWORD PTR $T207106[ebp]
...
; 219  : 	ListView_SetItemState(listControl, nCurrentRow, LVIS_SELECTED| LVIS_FOCUSED, LVIS_SELECTED| LVIS_FOCUSED); 
	...
	mov	DWORD PTR __ms_lvi$177748[ebp+16], 3
	mov	DWORD PTR __ms_lvi$177748[ebp+12], 3
	mov	esi, esp
	lea	ecx, DWORD PTR __ms_lvi$177748[ebp]
	push	ecx
	mov	edx, DWORD PTR _this$[ebp]
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlconv.h
xdata$x	SEGMENT
$T207157 DD	0ffffffffH
	DD	FLAT:$L207150
$T207152 DD	019930520H
	DD	01H
	DD	FLAT:$T207157
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 795  : 			return NULL;
	...
	mov	DWORD PTR $T207148[ebp], 0
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __AtlSafeAllocaManager$[ebp]
	call	??1?$CAtlSafeAllocBufferManager@VCCRTAllocator@ATL@@@_ATL_SAFE_ALLOCA_IMPL@ATL@@QAE@XZ ; ATL::_ATL_SAFE_ALLOCA_IMPL::CAtlSafeAllocBufferManager<ATL::CCRTAllocator>::~CAtlSafeAllocBufferManager<ATL::CCRTAllocator>
	mov	eax, DWORD PTR $T207148[ebp]
	jmp	SHORT $L76084
$L76112:
...
; 799  : 	return str;
	...
	mov	DWORD PTR $T207149[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR __AtlSafeAllocaManager$[ebp]
	call	??1?$CAtlSafeAllocBufferManager@VCCRTAllocator@ATL@@@_ATL_SAFE_ALLOCA_IMPL@ATL@@QAE@XZ ; ATL::_ATL_SAFE_ALLOCA_IMPL::CAtlSafeAllocBufferManager<ATL::CCRTAllocator>::~CAtlSafeAllocBufferManager<ATL::CCRTAllocator>
	mov	eax, DWORD PTR $T207149[ebp]
$L76084:
...
; 74   : 	for (int i=0; i<count;i++)
	...
	mov	DWORD PTR _i$204017[ebp], 0
	jmp	SHORT $L204018
$L204019:
	mov	ecx, DWORD PTR _i$204017[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$204017[ebp], ecx
$L204018:
	mov	edx, DWORD PTR _this$[ebp]
	mov	eax, DWORD PTR _i$204017[ebp]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207228 DD	0ffffffffH
	DD	FLAT:$L207216
	DD	00H
	DD	FLAT:$L207217
$T207219 DD	019930520H
	DD	02H
	DD	FLAT:$T207228
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
$T207208 = -168						; size = 4
$T207195 = -164						; size = 4
_rect$204251 = -156					; size = 16
_pszClassName$204247 = -136				; size = 4
_wnd$204246 = -128					; size = 4
_bstrLicKey$204136 = -116				; size = 4
_pSource$204133 = -108					; size = 4
_pBytes$204131 = -104					; size = 4
_h$204129 = -100					; size = 4
_spStream$204127 = -92					; size = 4
_dwLen$204126 = -84					; size = 4
_pData$204125 = -76					; size = 4
_wID$204122 = -68					; size = 4
_nItem$204118 = -64					; size = 2
_hWndPrev$204116 = -60					; size = 4
_pItem$204115 = -56					; size = 4
_nItems$204114 = -52					; size = 2
_bDialogEx$204113 = -48					; size = 4
_pDlg$204109 = -44					; size = 4
_hResource$204108 = -40					; size = 4
_hDlg$ = -36						; size = 4
_hr$ = -32						; size = 4
_hData$ = -28						; size = 4
...
; 3506 : 			HGLOBAL hResource = ::LoadResource(_AtlBaseModule.GetResourceInstance(), hDlg);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hResource$204108[ebp], eax

; 3507 : 			DLGTEMPLATE* pDlg = NULL;

	mov	DWORD PTR _pDlg$204109[ebp], 0

; 3508 : 			if (hResource != NULL)

	cmp	DWORD PTR _hResource$204108[ebp], 0
	je	$L204110
...
; 3510 : 				pDlg = (DLGTEMPLATE*) ::LockResource(hResource);
	...
	mov	esi, esp
	mov	edx, DWORD PTR _hResource$204108[ebp]
	push	edx
	call	DWORD PTR __imp__LockResource@4
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _pDlg$204109[ebp], eax

; 3511 : 				if (pDlg != NULL)

	cmp	DWORD PTR _pDlg$204109[ebp], 0
	je	$L204112
...
; 3518 : 					DLGITEMTEMPLATE* pItem = _DialogSplitHelper::FindFirstDlgItem(pDlg);
	...
	add	esp, 4
	mov	DWORD PTR _pItem$204115[ebp], eax

; 3519 : 					HWND hWndPrev = GetWindow(GW_CHILD);

	push	5
	lea	ecx, DWORD PTR $T207195[ebp]
	push	ecx
	mov	ecx, DWORD PTR _this$[ebp]
	add	ecx, 4
	...
	mov	ecx, eax
	call	??BCWindow@ATL@@QBEPAUHWND__@@XZ	; ATL::CWindow::operator HWND__ *
	mov	DWORD PTR _hWndPrev$204116[ebp], eax
...
; 3522 : 					for (WORD nItem = 0; nItem < nItems; nItem++)
	...
	mov	WORD PTR _nItem$204118[ebp], 0
	jmp	SHORT $L204119
$L204120:
	mov	dx, WORD PTR _nItem$204118[ebp]
	add	dx, 1
	mov	WORD PTR _nItem$204118[ebp], dx
$L204119:
	movzx	eax, WORD PTR _nItem$204118[ebp]
	movzx	ecx, WORD PTR _nItems$204114[ebp]
	cmp	eax, ecx
	jge	$L204121
...
; 3524 : 						DWORD wID = bDialogEx ? ((_DialogSplitHelper::DLGITEMTEMPLATEEX*)pItem)->id : pItem->id;
	...
	cmp	DWORD PTR _bDialogEx$204113[ebp], 0
	je	SHORT $L207196
	mov	edx, DWORD PTR _pItem$204115[ebp]
	mov	eax, DWORD PTR [edx+20]
	mov	DWORD PTR tv150[ebp], eax
	jmp	SHORT $L207197
$L207196:
	mov	ecx, DWORD PTR _pItem$204115[ebp]
	movzx	edx, WORD PTR [ecx+16]
	mov	DWORD PTR tv150[ebp], edx
$L207197:
	mov	eax, DWORD PTR tv150[ebp]
	mov	DWORD PTR _wID$204122[ebp], eax

; 3525 : 						if (_DialogSplitHelper::IsActiveXControl(pItem, bDialogEx))

	mov	ecx, DWORD PTR _bDialogEx$204113[ebp]
	push	ecx
	mov	edx, DWORD PTR _pItem$204115[ebp]
	push	edx
...
; 3532 : 								HGLOBAL h = GlobalAlloc(GHND, dwLen);
	...
	mov	esi, esp
	mov	ecx, DWORD PTR _dwLen$204126[ebp]
	push	ecx
	push	66					; 00000042H
	call	DWORD PTR __imp__GlobalAlloc@8
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _h$204129[ebp], eax

; 3533 : 								if (h != NULL)

	cmp	DWORD PTR _h$204129[ebp], 0
	je	SHORT $L204130
...
; 3535 : 									BYTE* pBytes = (BYTE*) GlobalLock(h);
	...
	mov	esi, esp
	mov	edx, DWORD PTR _h$204129[ebp]
	push	edx
	call	DWORD PTR __imp__GlobalLock@4
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _pBytes$204131[ebp], eax

; 3536 : 									BYTE* pSource = pData; 

	mov	eax, DWORD PTR _pData$204125[ebp]
	mov	DWORD PTR _pSource$204133[ebp], eax

; 3537 : 									memcpy(pBytes, pSource, dwLen);

	mov	ecx, DWORD PTR _dwLen$204126[ebp]
	push	ecx
	mov	edx, DWORD PTR _pSource$204133[ebp]
	push	edx
	mov	eax, DWORD PTR _pBytes$204131[ebp]
	push	eax
	call	_memcpy
	add	esp, 12					; 0000000cH
...
; 3538 : 									GlobalUnlock(h);
	...
	mov	esi, esp
	mov	ecx, DWORD PTR _h$204129[ebp]
	push	ecx
...
; 3548 : 							CComBSTR bstrLicKey;
	...
	lea	ecx, DWORD PTR _bstrLicKey$204136[ebp]
	call	??0CComBSTR@ATL@@QAE@XZ			; ATL::CComBSTR::CComBSTR
	mov	BYTE PTR __$EHRec$[ebp+8], 1

; 3549 : 							hr = _DialogSplitHelper::ParseInitData(spStream, &bstrLicKey.m_str);

	lea	eax, DWORD PTR _bstrLicKey$204136[ebp]
	push	eax
	lea	ecx, DWORD PTR _spStream$204127[ebp]
...
; 3552 : 								CAxWindow2 wnd;
	...
	push	0
	lea	ecx, DWORD PTR _wnd$204246[ebp]
...
$L207199:
	...
	mov	DWORD PTR _pszClassName$204247[ebp], eax
...
; 3563 : 										pItem->x;
	...
	jmp	SHORT $L207201
$L207200:
	mov	eax, DWORD PTR _pItem$204115[ebp]
	mov	cx, WORD PTR [eax+8]
	mov	WORD PTR tv197[ebp], cx
$L207201:
	movsx	edx, WORD PTR tv197[ebp]
	mov	DWORD PTR _rect$204251[ebp], edx
...
$L207203:
	...
	mov	DWORD PTR _rect$204251[ebp+4], ecx
...
$L207205:
	...
	add	eax, DWORD PTR _rect$204251[ebp]
	mov	DWORD PTR _rect$204251[ebp+8], eax
...
$L207207:
	...
	add	edx, DWORD PTR _rect$204251[ebp+4]
	mov	DWORD PTR _rect$204251[ebp+12], edx

; 3576 : 
; 3577 : 								// Convert from dialog units to screen units
; 3578 : 								MapDialogRect(&rect);

	lea	eax, DWORD PTR _rect$204251[ebp]
	push	eax
	mov	ecx, DWORD PTR _this$[ebp]
...
$L207214:
	...
	push	ecx
	mov	ecx, esp
	mov	DWORD PTR $T207215[ebp], esp
	lea	edx, DWORD PTR _rect$204251[ebp]
	push	edx
...
; 3601 : 									hr = wnd.CreateControlLic(pszClassName, spStream, NULL, bstrLicKey);
	...
	call	??B?$CComPtrBase@UIStream@@@ATL@@QBEPAUIStream@@XZ ; ATL::CComPtrBase<IStream>::operator IStream *
	push	eax
	mov	edx, DWORD PTR _pszClassName$204247[ebp]
	push	edx
	lea	ecx, DWORD PTR _wnd$204246[ebp]
...
; 3606 : 										hWndPrev = HWND_TOP;
	...
	mov	DWORD PTR _hWndPrev$204116[ebp], 0
$L204267:
...
; 3607 : 									wnd.SetWindowPos(hWndPrev, 0,0,0,0,SWP_NOACTIVATE | SWP_NOMOVE | SWP_NOSIZE);
	...
	push	0
	push	0
	mov	ecx, DWORD PTR _hWndPrev$204116[ebp]
	push	ecx
	lea	ecx, DWORD PTR _wnd$204246[ebp]
...
; 3618 : 							if (nItem != 0)
	...
	movzx	edx, WORD PTR _nItem$204118[ebp]
	test	edx, edx
	je	SHORT $L204270
...
; 3619 : 								hWndPrev = ::GetWindow(hWndPrev, GW_HWNDNEXT);
	...
	mov	esi, esp
	push	2
	mov	eax, DWORD PTR _hWndPrev$204116[ebp]
	push	eax
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207293 DD	0ffffffffH
	DD	FLAT:$L207279
$T207281 DD	019930520H
	DD	01H
	DD	FLAT:$T207293
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 629  : 				return E_OUTOFMEMORY;
	...
	mov	DWORD PTR $T207275[ebp], -2147024882	; 8007000eH
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _bstr$98873[ebp]
	call	??1CComBSTR@ATL@@QAE@XZ			; ATL::CComBSTR::~CComBSTR
	mov	eax, DWORD PTR $T207275[ebp]
	jmp	$L98855
$L98874:
...
; 633  : 				return hr;
	...
	mov	DWORD PTR $T207276[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _bstr$98873[ebp]
	call	??1CComBSTR@ATL@@QAE@XZ			; ATL::CComBSTR::~CComBSTR
	mov	eax, DWORD PTR $T207276[ebp]
	jmp	$L98855
$L98880:
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207348 DD	0ffffffffH
	DD	FLAT:$L207339
	DD	00H
	DD	FLAT:$L207340
$T207342 DD	019930520H
	DD	02H
	DD	FLAT:$T207348
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 2173 : 			return AtlAxCreateControlLicEx(lpszName, m_hWnd, pStream, ppUnkContainer, ppUnkControl, iidSink, punkSink, bstrLicKey);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T207336[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _spWinHost$[ebp]
	call	??1?$CComPtr@UIAxWinHostWindowLic@@@ATL@@QAE@XZ
	mov	eax, DWORD PTR $T207336[ebp]
	jmp	$L205264
$L205346:
...
; 3682 : 		if (FAILED(hr = pThis->CreateActiveXControls(pThis->GetIDD())))
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR _hr$205533[ebp], eax
	cmp	DWORD PTR _hr$205533[ebp], 0
	jge	SHORT $L205532
...
; 3685 : 			SetLastError(hr & 0x0000FFFF);
	...
	mov	eax, DWORD PTR _hr$205533[ebp]
	and	eax, 65535				; 0000ffffH
	mov	esi, esp
	push	eax
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207397 DD	0ffffffffH
	DD	FLAT:$L207390
$T207392 DD	019930520H
	DD	01H
	DD	FLAT:$T207397
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 2073 : 		return hr;
	...
	mov	eax, DWORD PTR _hr$[ebp]
	mov	DWORD PTR $T207389[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _spUnk$[ebp]
	call	??1?$CComPtr@UIUnknown@@@ATL@@QAE@XZ
	mov	eax, DWORD PTR $T207389[ebp]
$L205684:
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlbase.h
xdata$x	SEGMENT
$T207537 DD	0ffffffffH
	DD	FLAT:$L207533
$T207535 DD	019930520H
	DD	01H
	DD	FLAT:$T207537
	DD	2 DUP(00H)
	DD	2 DUP(00H)
