...
CONST	ENDS
CONST	SEGMENT
$SG197368 DB	'Invalid DateTime', 00H
CONST	ENDS
;	COMDAT ?szInvalidDateTime@ATL@@3QBDB
CONST	SEGMENT
?szInvalidDateTime@ATL@@3QBDB DD FLAT:$SG197368		; ATL::szInvalidDateTime
CONST	ENDS
CONST	SEGMENT
	ORG $+3
$SG197370 DB	'Invalid DateTimeSpan', 00H
CONST	ENDS
;	COMDAT ?szInvalidDateTimeSpan@ATL@@3QBDB
CONST	SEGMENT
?szInvalidDateTimeSpan@ATL@@3QBDB DD FLAT:$SG197370	; ATL::szInvalidDateTimeSpan
CONST	ENDS
;	COMDAT ?licenseTimeout@CLicense@@0HB
CONST	SEGMENT
...
CONST	SEGMENT
	ORG $+3
$SG205794 DB	'pThis != 0', 00H
	ORG $+1
$SG205795 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
	DB	'tlmfc\include\atlwin.h', 00H
	ORG $+1
$SG205805 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
	DB	'tlmfc\include\atlwin.h', 00H
	ORG $+1
$SG205806 DB	'Subclassing through a hook discarded.', 0aH, 00H
	ORG $+1
$SG205812 DB	'pp != 0', 00H
$SG205813 DB	'C:\Program Files\Microsoft Visual Studio .NET 2003\Vc7\a'
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207442 DD	0ffffffffH
	DD	FLAT:$L207429
	DD	00H
	DD	FLAT:$L207430
$T207434 DD	019930520H
	DD	02H
	DD	FLAT:$T207442
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207469 DD	0ffffffffH
	DD	FLAT:$L207461
$T207463 DD	019930520H
	DD	01H
	DD	FLAT:$T207469
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 341  :                    EXCEPTION_CONTINUE_SEARCH)
	...
	mov	DWORD PTR $T207479[ebp], eax
	mov	eax, DWORD PTR $T207479[ebp]
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T207525 DD	0ffffffffH
	DD	FLAT:$L207517
$T207519 DD	019930520H
	DD	01H
	DD	FLAT:$T207525
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 235  : 	return ::GetStringTypeExA(lcid, dwInfoType, pszA, nLengthA, pwCharType);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T207516[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _pszA$[ebp]
	call	??1?$CTempBuffer@D$0IA@VCCRTAllocator@ATL@@@ATL@@QAE@XZ ; ATL::CTempBuffer<char,128,ATL::CCRTAllocator>::~CTempBuffer<char,128,ATL::CCRTAllocator>
	mov	eax, DWORD PTR $T207516[ebp]
...
; 2743 : 			return hr;
	...
	mov	eax, DWORD PTR _hr$[ebp]
	mov	DWORD PTR $T207567[ebp], eax
	lea	ecx, DWORD PTR _spRegistrar$[ebp]
	call	??1?$CComPtr@UIRegistrar@@@ATL@@QAE@XZ
	mov	eax, DWORD PTR $T207567[ebp]
	jmp	$L88226
$L88304:
...
; 2757 : 			return hr;
	...
	mov	eax, DWORD PTR _hr$[ebp]
	mov	DWORD PTR $T207569[ebp], eax
	lea	ecx, DWORD PTR _spRegistrar$[ebp]
	call	??1?$CComPtr@UIRegistrar@@@ATL@@QAE@XZ
	mov	eax, DWORD PTR $T207569[ebp]
	jmp	SHORT $L88226
$L88324:
...
; 2760 : 			NULL, spRegistrar);
	...
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR $T207570[ebp], eax
	lea	ecx, DWORD PTR _spRegistrar$[ebp]
	call	??1?$CComPtr@UIRegistrar@@@ATL@@QAE@XZ
	mov	eax, DWORD PTR $T207570[ebp]
$L88226:
...
tv86 = -308						; size = 4
tv90 = -304						; size = 4
_pszModulePath$204025 = -300				; size = 4
__lpa$204024 = -296					; size = 4
__lpw$204023 = -292					; size = 4
__acp$204022 = -288					; size = 4
__convert$204021 = -284					; size = 4
_i$204016 = -280					; size = 4
_len$204015 = -276					; size = 4
_ModulePath$204014 = -268				; size = 260
__$ArrayPad$ = -4					; size = 4
__$ReturnAddr$ = 4					; size = 4
_hInstance$ = 8						; size = 4
_dwReason$ = 12						; size = 4
...
; 72   : 		::GetModuleFileName(hInstance, ModulePath, MAX_PATH);
	...
	mov	esi, esp
	push	260					; 00000104H
	lea	ecx, DWORD PTR _ModulePath$204014[ebp]
	push	ecx
...
; 73   : 		int len = _tcslen(ModulePath);
	...
	lea	eax, DWORD PTR _ModulePath$204014[ebp]
	push	eax
	call	_strlen
	add	esp, 4
	mov	DWORD PTR _len$204015[ebp], eax

; 74   : 
; 75   : 		for ( int i = len; i > 0; i--)

	mov	ecx, DWORD PTR _len$204015[ebp]
	mov	DWORD PTR _i$204016[ebp], ecx
	jmp	SHORT $L204017
$L204018:
	mov	edx, DWORD PTR _i$204016[ebp]
	sub	edx, 1
	mov	DWORD PTR _i$204016[ebp], edx
$L204017:
	cmp	DWORD PTR _i$204016[ebp], 0
	jle	$L204019

; 76   : 			if ( ModulePath[i] == _T('\\'))

	mov	eax, DWORD PTR _i$204016[ebp]
	movsx	ecx, BYTE PTR _ModulePath$204014[ebp+eax]
...
; 78   : 				USES_CONVERSION;
	...
	mov	DWORD PTR __convert$204021[ebp], 0
	call	?_AtlGetConversionACP@ATL@@YGIXZ	; ATL::_AtlGetConversionACP
	mov	DWORD PTR __acp$204022[ebp], eax
	mov	DWORD PTR __lpw$204023[ebp], 0
	mov	DWORD PTR __lpa$204024[ebp], 0

; 79   : 				ModulePath[i] = _T('\0');

	mov	edx, DWORD PTR _i$204016[ebp]
	mov	BYTE PTR _ModulePath$204014[ebp+edx], 0

; 80   : 
; 81   : 				OLECHAR* pszModulePath = T2OLE(ModulePath);

	lea	eax, DWORD PTR _ModulePath$204014[ebp]
	mov	DWORD PTR __lpa$204024[ebp], eax
	cmp	DWORD PTR __lpa$204024[ebp], 0
	jne	SHORT $L207583
	mov	DWORD PTR tv90[ebp], 0
	jmp	SHORT $L207584
$L207583:
	mov	esi, esp
	mov	ecx, DWORD PTR __lpa$204024[ebp]
	push	ecx
	call	DWORD PTR __imp__lstrlenA@4
	cmp	esi, esp
	call	__RTC_CheckEsp
	add	eax, 1
	mov	DWORD PTR __convert$204021[ebp], eax
	mov	eax, DWORD PTR __convert$204021[ebp]
	shl	eax, 1
	add	eax, 3
	and	eax, -4					; fffffffcH
	call	__alloca_probe
	mov	DWORD PTR tv86[ebp], esp
	mov	edx, DWORD PTR __acp$204022[ebp]
	push	edx
	mov	eax, DWORD PTR __convert$204021[ebp]
	push	eax
	mov	ecx, DWORD PTR __lpa$204024[ebp]
...
$L207584:
	...
	mov	DWORD PTR _pszModulePath$204025[ebp], eax

; 82   : 				wcscpy( szModulePath, pszModulePath);

	mov	ecx, DWORD PTR _pszModulePath$204025[ebp]
	push	ecx
...
; 1759 : 		ATLTRY(p = new T1(pv))
	...
	mov	DWORD PTR $T207641[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+12], 1
	cmp	DWORD PTR $T207641[ebp], 0
	je	SHORT $L207642
	mov	eax, DWORD PTR _pv$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T207641[ebp]
...
$L207643:
	...
	mov	DWORD PTR $T207640[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	mov	eax, DWORD PTR $T207640[ebp]
...
; 1771 : 				delete p;
	...
	mov	ecx, DWORD PTR _p$[ebp]
	mov	DWORD PTR $T207645[ebp], ecx
	mov	edx, DWORD PTR $T207645[ebp]
	mov	DWORD PTR $T207644[ebp], edx
	cmp	DWORD PTR $T207644[ebp], 0
	je	SHORT $L207646
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T207644[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T207644[ebp]
	call	DWORD PTR [edx+20]
	cmp	esi, esp
	call	__RTC_CheckEsp
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlcom.h
xdata$x	SEGMENT
$T207688 DD	0ffffffffH
	DD	FLAT:$L207683
$T207686 DD	019930520H
	DD	01H
	DD	FLAT:$T207688
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 138  : 			if (STATUS_NO_MEMORY == GetExceptionCode())
	...
	cmp	DWORD PTR $T207702[ebp], -1073741801	; c0000017H
	jne	SHORT $L77330
...
; 2593 : 			delete this;
	...
	mov	edx, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T207741[ebp], edx
	mov	eax, DWORD PTR $T207741[ebp]
	mov	DWORD PTR $T207740[ebp], eax
	cmp	DWORD PTR $T207740[ebp], 0
	je	SHORT $L207742
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T207740[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T207740[ebp]
	call	DWORD PTR [edx+20]
	cmp	esi, esp
...
; 1759 : 		ATLTRY(p = new T1(pv))
	...
	mov	DWORD PTR tv142[ebp], eax
	mov	edx, DWORD PTR tv142[ebp]
	mov	DWORD PTR $T207758[ebp], edx
	cmp	DWORD PTR $T207758[ebp], 0
	je	SHORT $L207759
	mov	eax, DWORD PTR _pv$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T207758[ebp]
...
; 1771 : 				delete p;
	...
	mov	edx, DWORD PTR _p$[ebp]
	mov	DWORD PTR $T207762[ebp], edx
	mov	eax, DWORD PTR $T207762[ebp]
	mov	DWORD PTR $T207761[ebp], eax
	cmp	DWORD PTR $T207761[ebp], 0
	je	SHORT $L207763
	mov	esi, esp
	push	1
	mov	ecx, DWORD PTR $T207761[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR $T207761[ebp]
...
; 1759 : 		ATLTRY(p = new T1(pv))
	...
	mov	DWORD PTR tv145[ebp], eax
	mov	edx, DWORD PTR tv145[ebp]
	mov	DWORD PTR $T207795[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+12], 1
	cmp	DWORD PTR $T207795[ebp], 0
	je	SHORT $L207796
	mov	eax, DWORD PTR _pv$[ebp]
	push	eax
	mov	ecx, DWORD PTR $T207795[ebp]
...
$L207797:
	mov	edx, DWORD PTR tv82[ebp]
	mov	DWORD PTR $T207794[ebp], edx
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	mov	eax, DWORD PTR $T207794[ebp]
	mov	DWORD PTR _p$[ebp], eax
	jmp	SHORT $L207802
$L207803:
	mov	eax, $L207802
...
; 1771 : 				delete p;
	...
	mov	ecx, DWORD PTR _p$[ebp]
	mov	DWORD PTR $T207799[ebp], ecx
	mov	edx, DWORD PTR $T207799[ebp]
	mov	DWORD PTR $T207798[ebp], edx
	cmp	DWORD PTR $T207798[ebp], 0
	je	SHORT $L207800
	mov	esi, esp
	push	1
	mov	eax, DWORD PTR $T207798[ebp]
	mov	edx, DWORD PTR [eax]
	mov	ecx, DWORD PTR $T207798[ebp]
...
; 3646 : 		return hRes;
	...
	mov	eax, DWORD PTR _hRes$[ebp]
	mov	DWORD PTR $T207867[ebp], eax
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1?$CComCritSecLock@VCComCriticalSection@ATL@@@ATL@@QAE@XZ ; ATL::CComCritSecLock<ATL::CComCriticalSection>::~CComCritSecLock<ATL::CComCriticalSection>
	mov	eax, DWORD PTR $T207867[ebp]
	jmp	$L92202
$L92213:
...
; 3662 : 					return E_OUTOFMEMORY;
	...
	mov	DWORD PTR $T207872[ebp], -2147024882	; 8007000eH
	mov	BYTE PTR __$EHRec$[ebp+8], 0
	lea	ecx, DWORD PTR __AtlSafeAllocaManager$92229[ebp]
	call	??1?$CAtlSafeAllocBufferManager@VCCRTAllocator@ATL@@@_ATL_SAFE_ALLOCA_IMPL@ATL@@QAE@XZ ; ATL::_ATL_SAFE_ALLOCA_IMPL::CAtlSafeAllocBufferManager<ATL::CCRTAllocator>::~CAtlSafeAllocBufferManager<ATL::CCRTAllocator>
	mov	DWORD PTR __$EHRec$[ebp+8], -1
...
; 3748 : 	return hRes;
	...
	mov	DWORD PTR $T207882[ebp], edx
	mov	DWORD PTR __$EHRec$[ebp+8], -1
	lea	ecx, DWORD PTR _lock$[ebp]
	call	??1?$CComCritSecLock@VCComCriticalSection@ATL@@@ATL@@QAE@XZ ; ATL::CComCritSecLock<ATL::CComCriticalSection>::~CComCritSecLock<ATL::CComCriticalSection>
	mov	eax, DWORD PTR $T207882[ebp]
$L92202:
...
; 3539 : 		delete [] p->m_pMap;
	...
	mov	DWORD PTR $T207920[ebp], ecx
	mov	edx, DWORD PTR $T207920[ebp]
	mov	DWORD PTR $T207919[ebp], edx
	cmp	DWORD PTR $T207919[ebp], 0
	je	SHORT $L207921
	push	3
	mov	ecx, DWORD PTR $T207919[ebp]
...
; 3601 : 				ATLTRY(pMap = new stringdispid[m_nCount]);
	...
	mov	DWORD PTR $T207925[ebp], ecx
	mov	edx, DWORD PTR $T207925[ebp]
	...
	mov	DWORD PTR $T207927[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 1
	cmp	DWORD PTR $T207927[ebp], 0
	je	SHORT $L207928
	mov	ecx, DWORD PTR $T207927[ebp]
	mov	edx, DWORD PTR $T207925[ebp]
	mov	DWORD PTR [ecx], edx
	push	OFFSET FLAT:??1stringdispid@CComTypeInfoHolder@ATL@@QAE@XZ
	push	OFFSET FLAT:??0stringdispid@CComTypeInfoHolder@ATL@@QAE@XZ ; ATL::CComTypeInfoHolder::stringdispid::stringdispid
	mov	eax, DWORD PTR $T207925[ebp]
	push	eax
	push	12					; 0000000cH
	mov	ecx, DWORD PTR $T207927[ebp]
	add	ecx, 4
...
$L207929:
	...
	mov	DWORD PTR $T207926[ebp], eax
	mov	BYTE PTR __$EHRec$[ebp+12], 0
	mov	ecx, DWORD PTR $T207926[ebp]
...
; 2511 : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T207981[ebp], eax
	mov	ecx, DWORD PTR $T207981[ebp]
	mov	DWORD PTR $T207980[ebp], ecx
	cmp	DWORD PTR $T207980[ebp], 0
	je	SHORT $L207982
	mov	esi, esp
	push	1
	mov	edx, DWORD PTR $T207980[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T207980[ebp]
...
; File c:\program files\microsoft visual studio .net 2003\vc7\atlmfc\include\atlcom.h
xdata$x	SEGMENT
$T207996 DD	0ffffffffH
	DD	FLAT:$L207992
$T207994 DD	019930520H
	DD	01H
	DD	FLAT:$T207996
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 2880 : 			delete this;
	...
	mov	eax, DWORD PTR _this$[ebp]
	mov	DWORD PTR $T208006[ebp], eax
	mov	ecx, DWORD PTR $T208006[ebp]
	mov	DWORD PTR $T208005[ebp], ecx
	cmp	DWORD PTR $T208005[ebp], 0
	je	SHORT $L208007
	mov	esi, esp
	push	1
	mov	edx, DWORD PTR $T208005[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR $T208005[ebp]
	call	DWORD PTR [eax+12]
	cmp	esi, esp
	call	__RTC_CheckEsp
	mov	DWORD PTR tv74[ebp], eax
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T208024 DD	0ffffffffH
	DD	FLAT:$L208020
$T208022 DD	019930520H
	DD	01H
	DD	FLAT:$T208024
	DD	2 DUP(00H)
	DD	2 DUP(00H)
...
; 2726 : 		return UpdateRegistryFromResourceDHelper(pwszTemp, bRegister, pMapEntries);
	...
	push	eax
	call	?UpdateRegistryFromResourceDHelper@CAtlModule@ATL@@QAGJPBGHPAU_ATL_REGMAP_ENTRY@2@@Z ; ATL::CAtlModule::UpdateRegistryFromResourceDHelper
	mov	DWORD PTR $T208211[ebp], eax
	lea	ecx, DWORD PTR __AtlSafeAllocaManager$[ebp]
	call	??1?$CAtlSafeAllocBufferManager@VCCRTAllocator@ATL@@@_ATL_SAFE_ALLOCA_IMPL@ATL@@QAE@XZ ; ATL::_ATL_SAFE_ALLOCA_IMPL::CAtlSafeAllocBufferManager<ATL::CCRTAllocator>::~CAtlSafeAllocBufferManager<ATL::CCRTAllocator>
	mov	eax, DWORD PTR $T208211[ebp]
$L88203:
...
;	COMDAT xdata$x
xdata$x	SEGMENT
$T208250 DD	0ffffffffH
	DD	FLAT:$L208246
$T208248 DD	019930520H
	DD	01H
	DD	FLAT:$T208250
	DD	2 DUP(00H)
	DD	2 DUP(00H)
