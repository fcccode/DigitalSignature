========================================================================
    ACTIVE TEMPLATE LIBRARY : SigWinImage Project Overview
========================================================================

AppWizard has created this SigWinImage project for you to use as the starting point for
...
_SigWinImage.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_SigWinImage.h)
        GUID definitions                                (_SigWinImage_i.c)
        A type library                                  (_SigWinImage.tlb)
        Marshaling code                                 (_SigWinImage_p.c and dlldata.c)
SigWinImage.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named SigWinImage.pch and a precompiled types file named StdAfx.obj.
...
SigWinImageps.vcproj
	...
	dlldata.c, SigWinImage_i.c and SigWinImage_p.c which are required
