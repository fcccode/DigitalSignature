...
public abstract class Message
{
    ...
    public String readLine(InputStream in) throws IOException
    {
        ...
        String rst = new String(buf, 0, offset);
        return rst;
    }
    ...
    private final static String COLON_SPACE = ": ";
    private final static String CRLF = "\r\n";

    private byte[] toByteArray(String sep)
    {
        if (hnumread==0) return null;
