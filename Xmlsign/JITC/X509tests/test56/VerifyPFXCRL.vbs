...
expectedRes = 1
	...
	ActiveCertPath = "test56.p12"
	crlList2(0) = "Trust Anchor CRL CP.01.01.crl"
	crlList2(1) = "Intermediate CRL PL.01.03.crl"
	...
	if res = expectedRes then
		...
		fHandle.writeline("Test 56 Failed. Certificate Validation Failed " & "Last Error: " & SecureXML.GetLastError)
	End if
