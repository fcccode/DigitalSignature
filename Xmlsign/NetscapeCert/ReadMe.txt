========================================================================
    ACTIVE TEMPLATE LIBRARY : NetscapeCert Project Overview
========================================================================

AppWizard has created this NetscapeCert project for you to use as the starting point for
...
_NetscapeCert.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_NetscapeCert.h)
        GUID definitions                                (_NetscapeCert_i.c)
        A type library                                  (_NetscapeCert.tlb)
        Marshaling code                                 (_NetscapeCert_p.c and dlldata.c)
NetscapeCert.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named NetscapeCert.pch and a precompiled types file named StdAfx.obj.
...
NetscapeCertps.vcproj
	...
	dlldata.c, NetscapeCert_i.c and NetscapeCert_p.c which are required
